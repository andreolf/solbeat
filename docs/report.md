...
> Generated 2026-09-11T16:30:10Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1032 is 88% complete (~5h remaining), with the cluster processing ~4,764 TPS (2,666 non-vote). Measured slot time is 320ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $875.6K of Real Economic Value over the last 24h ($608/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $101.75 (+2.6% / 24h). Decentralization: Nakamoto coefficient 18, 675 active validators, 0.4% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 446,202,685 |
| Block height | 424,245,763 |
| Epoch | 1032 (87.66% complete, ~4.7h left) |
| TPS (10 min avg) | 4,764 |
| Non-vote TPS | 2,666 |
| Slot time (measured) | 320.1 ms |
| Est. daily transactions | 397,526,658 |
...
| Metric | Value |
|---|---|
| SOL price | $101.75 (+2.6%/24h) |
| Market cap | $59.6B |
| **REV (24h)** | **$875.6K** (fees $709.3K + Jito tips $166.3K) |
| Chain TVL | $5.8B |
| Stablecoin supply | $16.3B |
| DEX volume (24h) | $2.9B (-2.6%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 586,537,291 SOL |
| Inflation | 3.65% |
...
Crypto Fear & Greed: 56 (Greed) · CoinGecko votes bullish: 84.62% · headline tone (48h): +6
