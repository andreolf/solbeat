...
> Generated 2026-09-13T05:25:00Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1033 is 85% complete (~6h remaining), with the cluster processing ~3,378 TPS (1,233 non-vote). Measured slot time is 314ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $845.6K of Real Economic Value over the last 24h ($587/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $101.82 (+0.3% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.4% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 446,622,289 |
| Block height | 424,664,986 |
| Epoch | 1033 (84.79% complete, ~5.7h left) |
| TPS (10 min avg) | 3,378 |
| Non-vote TPS | 1,233 |
| Slot time (measured) | 314.2 ms |
| Est. daily transactions | 313,579,176 |
...
| Metric | Value |
|---|---|
| SOL price | $101.82 (+0.3%/24h) |
| Market cap | $59.7B |
| **REV (24h)** | **$845.6K** (fees $708.8K + Jito tips $136.8K) |
| Chain TVL | $5.9B |
| Stablecoin supply | $16.5B |
| DEX volume (24h) | $2.5B (-22.3%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 586,644,808 SOL |
| Inflation | 3.65% |

Top DEXs by 24h volume: BisonFi ($471.7M), PumpSwap ($377.2M), Raydium AMM ($323.0M), Tessera V ($202.0M), Meteora DLMM ($161.1M)
...
Crypto Fear & Greed: 61 (Greed) · CoinGecko votes bullish: 69.44% · headline tone (48h): +1
...
|---|---|---|
| solana_rpc | OK | 11481 ms |
| solana_rpc_validators | OK | 1184 ms |
| coingecko | OK | 1801 ms |
| defillama_tvl | OK | 552 ms |
| defillama_dex | OK | 1017 ms |
| defillama_fees | OK | 16325 ms |
| defillama_stablecoins | OK | 369 ms |
| defillama_xstocks | OK | 676 ms |
| jito_kobe | OK | 406 ms |
| stakewiz | OK | 1247 ms |
| github | OK | 855 ms |
...
| solana_rpc_whales | OK | 2295 ms |
| solana_rpc_programs | OK | 4014 ms |
