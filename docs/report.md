...
> Generated 2026-09-24T12:55:34Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1041 is 75% complete (~8h remaining), with the cluster processing ~4,241 TPS (1,715 non-vote). Measured slot time is 266ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.2M of Real Economic Value over the last 24h ($849/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $113.49 (-2.8% / 24h). Decentralization: Nakamoto coefficient 18, 674 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 1 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 450,035,025 |
| Block height | 428,075,128 |
| Epoch | 1041 (74.77% complete, ~8.0h left) |
| TPS (10 min avg) | 4,241 |
| Non-vote TPS | 1,715 |
| Slot time (measured) | 265.8 ms |
| Est. daily transactions | 361,719,472 |
...
| Metric | Value |
|---|---|
| SOL price | $113.49 (-2.8%/24h) |
| Market cap | $66.7B |
| **REV (24h)** | **$1.2M** (fees $1.0M + Jito tips $211.1K) |
| Chain TVL | $6.3B |
| Stablecoin supply | $16.4B |
| DEX volume (24h) | $2.6B (-20.1%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,577,177 SOL |
| Inflation | 3.63% |

Top DEXs by 24h volume: Orca DEX ($347.4M), Raydium AMM ($335.8M), BisonFi ($323.9M), PumpSwap ($270.2M), Meteora DLMM ($233.7M)
...
| defillama_stablecoins | OK | 791 ms |
