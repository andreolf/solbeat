...
| Health | ok |
| Slot | 450,694,965 |
| Block height | 428,734,734 |
| Epoch | 1043 (27.54% complete, ~23.4h left) |
| TPS (10 min avg) | 4,169 |
| Non-vote TPS | 1,661 |
| Slot time (measured) | 268.6 ms |
| Est. daily transactions | 367,617,722 |
...
| Circulating supply | 587,712,698 SOL |
| Inflation | 3.63% |
...
Crypto Fear & Greed: 74 (Greed) · CoinGecko votes bullish: 86.49% · headline tone (48h): +7
