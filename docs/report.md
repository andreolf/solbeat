...
> Generated 2026-09-17T13:08:49Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1036 is 58% complete (~16h remaining), with the cluster processing ~4,015 TPS (1,894 non-vote). Measured slot time is 317ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $889.1K of Real Economic Value over the last 24h ($617/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $100.65 (+3.6% / 24h). Decentralization: Nakamoto coefficient 18, 676 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,802,889 |
| Block height | 425,844,069 |
| Epoch | 1036 (58.08% complete, ~16.0h left) |
| TPS (10 min avg) | 4,015 |
| Non-vote TPS | 1,894 |
| Slot time (measured) | 317.3 ms |
| Est. daily transactions | 318,415,500 |
...
| Circulating supply | 587,212,159 SOL |
| Inflation | 3.64% |
...
Crypto Fear & Greed: 50 (Neutral) · CoinGecko votes bullish: 63.33% · headline tone (48h): +1
...
|---|---|---|
| solana_rpc | OK | 9214 ms |
| solana_rpc_validators | OK | 295 ms |
| coingecko | OK | 1703 ms |
| defillama_tvl | OK | 226 ms |
| defillama_dex | OK | 941 ms |
| defillama_fees | OK | 1545 ms |
| defillama_stablecoins | OK | 374 ms |
| defillama_xstocks | OK | 109 ms |
| jito_kobe | OK | 304 ms |
| stakewiz | OK | 1109 ms |
| github | OK | 804 ms |
...
| solana_rpc_whales | OK | 1150 ms |
| solana_rpc_programs | OK | 2105 ms |
