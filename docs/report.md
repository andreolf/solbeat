...
> Generated 2026-09-19T03:43:12Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1037 is 71% complete (~9h remaining), with the cluster processing ~4,267 TPS (1,738 non-vote). Measured slot time is 267ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.1M of Real Economic Value over the last 24h ($736/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $113.29 (+8.9% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 1 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 448,289,095 |
| Block height | 426,329,954 |
| Epoch | 1037 (70.62% complete, ~9.4h left) |
| TPS (10 min avg) | 4,267 |
| Non-vote TPS | 1,738 |
| Slot time (measured) | 266.7 ms |
| Est. daily transactions | 387,226,789 |
...
| Metric | Value |
|---|---|
| SOL price | $113.29 (+8.9%/24h) |
| Market cap | $66.5B |
| **REV (24h)** | **$1.1M** (fees $813.1K + Jito tips $246.9K) |
| Chain TVL | $6.3B |
| Stablecoin supply | $15.8B |
| DEX volume (24h) | $3.3B (25.7%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,296,548 SOL |
| Inflation | 3.64% |

Top DEXs by 24h volume: PumpSwap ($488.3M), Raydium AMM ($418.7M), BisonFi ($378.3M), Orca DEX ($355.3M), HumidiFi ($281.6M)
...
|---|---|---|
| solana_rpc | OK | 7501 ms |
| solana_rpc_validators | OK | 269 ms |
| coingecko | OK | 1640 ms |
| defillama_tvl | OK | 44 ms |
| defillama_dex | OK | 1102 ms |
| defillama_fees | OK | 1994 ms |
...
| sentiment | FAILED | 7636 ms |
| solana_status_page | OK | 333 ms |
| solana_rpc_whales | OK | 1312 ms |
| solana_rpc_programs | OK | 1847 ms |
