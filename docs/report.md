...
| Health | ok |
| Slot | 446,390,310 |
| Block height | 424,433,111 |
| Epoch | 1033 (31.09% complete, ~26.1h left) |
| TPS (10 min avg) | 3,217 |
| Non-vote TPS | 1,086 |
| Slot time (measured) | 316.2 ms |
| Est. daily transactions | 298,689,537 |
...
| Circulating supply | 586,633,022 SOL |
| Inflation | 3.65% |
...
Crypto Fear & Greed: 63 (Greed) · CoinGecko votes bullish: 82.76% · headline tone (48h): +0
...
|---|---|---|
| solana_rpc | OK | 9030 ms |
| solana_rpc_validators | OK | 566 ms |
| coingecko | OK | 1716 ms |
| defillama_tvl | OK | 48 ms |
| defillama_dex | OK | 2131 ms |
| defillama_fees | OK | 1444 ms |
...
| solana_rpc_whales | OK | 1536 ms |
| solana_rpc_programs | OK | 2585 ms |
