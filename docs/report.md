...
> Generated 2026-09-17T00:52:57Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1036 is 26% complete (~28h remaining), with the cluster processing ~3,909 TPS (1,778 non-vote). Measured slot time is 317ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $829.3K of Real Economic Value over the last 24h ($576/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $98.78 (+1.7% / 24h). Decentralization: Nakamoto coefficient 18, 679 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,663,360 |
| Block height | 425,704,662 |
| Epoch | 1036 (25.78% complete, ~28.2h left) |
| TPS (10 min avg) | 3,909 |
| Non-vote TPS | 1,778 |
| Slot time (measured) | 316.9 ms |
| Est. daily transactions | 366,306,516 |
...
| Metric | Value |
|---|---|
| SOL price | $98.78 (+1.7%/24h) |
| Market cap | $58.0B |
| **REV (24h)** | **$829.3K** (fees $693.2K + Jito tips $136.1K) |
| Chain TVL | $5.7B |
| Stablecoin supply | $15.9B |
| DEX volume (24h) | $2.8B (2.8%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,212,611 SOL |
| Inflation | 3.64% |

Top DEXs by 24h volume: PumpSwap ($519.3M), BisonFi ($353.6M), fomo Wallet ($270.1M), Raydium AMM ($259.5M), Orca DEX ($243.4M)
...
Crypto Fear & Greed: 50 (Neutral) · CoinGecko votes bullish: 68.75% · headline tone (48h): +3
...
| solana_rpc_validators | OK | 105 ms |
| coingecko | OK | 1660 ms |
| defillama_tvl | OK | 230 ms |
| defillama_dex | OK | 773 ms |
| defillama_fees | OK | 3966 ms |
| defillama_stablecoins | OK | 80 ms |
...
| solana_rpc_programs | OK | 1798 ms |
