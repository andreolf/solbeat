...
> Generated 2026-09-11T07:50:27Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1032 is 65% complete (~13h remaining), with the cluster processing ~3,327 TPS (1,210 non-vote). Measured slot time is 316ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $874.3K of Real Economic Value over the last 24h ($607/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $99.81 (-1.3% / 24h). Decentralization: Nakamoto coefficient 18, 674 active validators, 0.5% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 446,104,372 |
| Block height | 424,147,614 |
| Epoch | 1032 (64.9% complete, ~13.3h left) |
| TPS (10 min avg) | 3,327 |
| Non-vote TPS | 1,210 |
| Slot time (measured) | 316.5 ms |
| Est. daily transactions | 319,908,488 |
...
| Metric | Value |
|---|---|
| SOL price | $99.81 (-1.3%/24h) |
| Market cap | $58.5B |
| **REV (24h)** | **$874.3K** (fees $709.3K + Jito tips $165.0K) |
| Chain TVL | $5.8B |
| Stablecoin supply | $16.3B |
| DEX volume (24h) | $2.9B (-1.7%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 586,537,629 SOL |
| Inflation | 3.65% |
...
Crypto Fear & Greed: 56 (Greed) · CoinGecko votes bullish: 71.74% · headline tone (48h): +0
...
|---|---|---|
| solana_rpc | OK | 9833 ms |
| solana_rpc_validators | OK | 342 ms |
| coingecko | OK | 1671 ms |
| defillama_tvl | OK | 821 ms |
| defillama_dex | OK | 910 ms |
| defillama_fees | OK | 1202 ms |
| defillama_stablecoins | OK | 179 ms |
| defillama_xstocks | OK | 66 ms |
| jito_kobe | OK | 314 ms |
| stakewiz | OK | 1201 ms |
| github | OK | 832 ms |
| solana_com_news | OK | 455 ms |
| sentiment | OK | 2309 ms |
| solana_status_page | OK | 494 ms |
| solana_rpc_whales | OK | 1190 ms |
| solana_rpc_programs | OK | 2137 ms |
