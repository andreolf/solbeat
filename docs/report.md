...
> Generated 2026-09-15T12:31:16Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1035 is 30% complete (~26h remaining), with the cluster processing ~3,624 TPS (1,471 non-vote). Measured slot time is 314ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $758.0K of Real Economic Value over the last 24h ($526/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $100.99 (-0.8% / 24h). Decentralization: Nakamoto coefficient 18, 679 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,250,535 |
| Block height | 425,292,411 |
| Epoch | 1035 (30.22% complete, ~26.3h left) |
| TPS (10 min avg) | 3,624 |
| Non-vote TPS | 1,471 |
| Slot time (measured) | 314.2 ms |
| Est. daily transactions | 301,151,328 |
...
| Circulating supply | 587,028,029 SOL |
| Inflation | 3.65% |
...
| sentiment | OK | 2056 ms |
| solana_status_page | OK | 270 ms |
| solana_rpc_whales | OK | 721 ms |
| solana_rpc_programs | OK | 1988 ms |
