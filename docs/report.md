...
> Generated 2026-09-19T01:40:08Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1037 is 64% complete (~11h remaining), with the cluster processing ~4,253 TPS (1,712 non-vote). Measured slot time is 265ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.1M of Real Economic Value over the last 24h ($737/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $113.09 (+11.0% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 3 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 448,261,392 |
| Block height | 426,302,263 |
| Epoch | 1037 (64.21% complete, ~11.4h left) |
| TPS (10 min avg) | 4,253 |
| Non-vote TPS | 1,712 |
| Slot time (measured) | 265.4 ms |
| Est. daily transactions | 401,653,935 |
...
| Metric | Value |
|---|---|
| SOL price | $113.09 (+11.0%/24h) |
| Market cap | $66.3B |
| **REV (24h)** | **$1.1M** (fees $813.1K + Jito tips $247.7K) |
| Chain TVL | $6.4B |
| Stablecoin supply | $15.8B |
| DEX volume (24h) | $3.1B (19.5%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,296,633 SOL |
| Inflation | 3.64% |
