...
> Generated 2026-08-31T18:30:40Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1025 is 97% complete (~1h remaining), with the cluster processing ~3,981 TPS (1,837 non-vote). Measured slot time is 315ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $857.6K of Real Economic Value over the last 24h ($596/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $103.76 (-2.7% / 24h). Decentralization: Nakamoto coefficient 18, 680 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 1 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 443,219,831 |
| Block height | 421,267,484 |
| Epoch | 1025 (97.18% complete, ~1.1h left) |
| TPS (10 min avg) | 3,981 |
| Non-vote TPS | 1,837 |
| Slot time (measured) | 315.4 ms |
| Est. daily transactions | 395,941,135 |
...
| Metric | Value |
|---|---|
| SOL price | $103.76 (-2.7%/24h) |
| Market cap | $60.7B |
| **REV (24h)** | **$857.6K** (fees $677.1K + Jito tips $180.6K) |
| Chain TVL | $5.8B |
| Stablecoin supply | $16.1B |
| DEX volume (24h) | $1.9B (15.5%/1d) |
| Tokenized equities (xStocks TVL) | $440.3M |
| Circulating supply | 585,120,769 SOL |
| Inflation | 3.67% |
...
| solana_rpc_programs | OK | 1793 ms |
