...
> Generated 2026-09-15T14:32:51Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1035 is 36% complete (~24h remaining), with the cluster processing ~3,998 TPS (1,854 non-vote). Measured slot time is 314ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $756.7K of Real Economic Value over the last 24h ($525/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $99.88 (-1.9% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,273,629 |
| Block height | 425,315,481 |
| Epoch | 1035 (35.56% complete, ~24.3h left) |
| TPS (10 min avg) | 3,998 |
| Non-vote TPS | 1,854 |
| Slot time (measured) | 314.5 ms |
| Est. daily transactions | 318,490,527 |
...
| Metric | Value |
|---|---|
| SOL price | $99.88 (-1.9%/24h) |
| Market cap | $58.7B |
| **REV (24h)** | **$756.7K** (fees $647.0K + Jito tips $109.7K) |
| Chain TVL | $5.9B |
| Stablecoin supply | $16.3B |
| DEX volume (24h) | $2.5B (41.3%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,027,953 SOL |
| Inflation | 3.65% |
...
| solana_status_page | FAILED | 66204 ms |
| solana_rpc_whales | OK | 774 ms |
| solana_rpc_programs | OK | 1882 ms |
