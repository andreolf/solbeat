...
> Generated 2026-09-24T14:26:48Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1041 is 80% complete (~7h remaining), with the cluster processing ~4,906 TPS (2,396 non-vote). Measured slot time is 267ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.2M of Real Economic Value over the last 24h ($850/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $115.41 (+1.4% / 24h). Decentralization: Nakamoto coefficient 18, 674 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 1 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 450,055,588 |
| Block height | 428,095,691 |
| Epoch | 1041 (79.53% complete, ~6.6h left) |
| TPS (10 min avg) | 4,906 |
| Non-vote TPS | 2,396 |
| Slot time (measured) | 267.4 ms |
| Est. daily transactions | 375,606,720 |
...
| Metric | Value |
|---|---|
| SOL price | $115.41 (+1.4%/24h) |
| Market cap | $67.8B |
| **REV (24h)** | **$1.2M** (fees $1.0M + Jito tips $213.4K) |
| Chain TVL | $6.3B |
| Stablecoin supply | $16.4B |
| DEX volume (24h) | $2.6B (-20.1%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,577,108 SOL |
| Inflation | 3.63% |
...
Crypto Fear & Greed: 71 (Greed) · CoinGecko votes bullish: 62.96% · headline tone (48h): +6
