...
> Generated 2026-09-22T06:40:48Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1040 is 5% complete (~31h remaining), with the cluster processing ~4,171 TPS (1,658 non-vote). Measured slot time is 268ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.3M of Real Economic Value over the last 24h ($922/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $116.75 (+4.2% / 24h). Decentralization: Nakamoto coefficient 18, 678 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 4 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 449,300,473 |
| Block height | 427,340,948 |
| Epoch | 1040 (4.74% complete, ~30.6h left) |
| TPS (10 min avg) | 4,171 |
| Non-vote TPS | 1,658 |
| Slot time (measured) | 268.1 ms |
| Est. daily transactions | 373,841,638 |
...
| Metric | Value |
|---|---|
| SOL price | $116.75 (+4.2%/24h) |
| Market cap | $68.6B |
| **REV (24h)** | **$1.3M** (fees $1.1M + Jito tips $231.6K) |
| Chain TVL | $6.4B |
| Stablecoin supply | $17.1B |
| DEX volume (24h) | $3.4B (20.6%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,508,248 SOL |
| Inflation | 3.64% |
...
| solana_rpc_whales | OK | 1074 ms |
| solana_rpc_programs | OK | 1755 ms |
