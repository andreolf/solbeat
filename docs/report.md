...
> Generated 2026-09-22T14:41:04Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1040 is 30% complete (~23h remaining), with the cluster processing ~5,037 TPS (2,535 non-vote). Measured slot time is 268ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.3M of Real Economic Value over the last 24h ($921/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $116.20 (-1.5% / 24h). Decentralization: Nakamoto coefficient 18, 675 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 5 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 449,408,674 |
| Block height | 427,449,053 |
| Epoch | 1040 (29.79% complete, ~22.6h left) |
| TPS (10 min avg) | 5,037 |
| Non-vote TPS | 2,535 |
| Slot time (measured) | 267.9 ms |
| Est. daily transactions | 368,429,010 |
...
| Metric | Value |
|---|---|
| SOL price | $116.20 (-1.5%/24h) |
| Market cap | $68.3B |
| **REV (24h)** | **$1.3M** (fees $1.1M + Jito tips $230.7K) |
| Chain TVL | $6.5B |
| Stablecoin supply | $17.1B |
| DEX volume (24h) | $3.4B (22.7%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,507,687 SOL |
| Inflation | 3.64% |

Top DEXs by 24h volume: Raydium AMM ($465.2M), BisonFi ($446.8M), Orca DEX ($419.0M), PumpSwap ($390.1M), Meteora DLMM ($259.6M)
...
- **[WARNING]** TPS spike: 5,037 vs 12h mean 4,237 (z=+2.2)
...
Crypto Fear & Greed: 78 (Extreme Greed) · CoinGecko votes bullish: 73.68% · headline tone (48h): +5
...
| solana_rpc_programs | OK | 2010 ms |
