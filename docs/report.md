...
> Generated 2026-09-22T04:05:32Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1039 is 97% complete (~1h remaining), with the cluster processing ~4,469 TPS (1,962 non-vote). Measured slot time is 268ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.3M of Real Economic Value over the last 24h ($875/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $116.66 (+4.7% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 4 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 449,265,523 |
| Block height | 427,306,011 |
| Epoch | 1039 (96.65% complete, ~1.1h left) |
| TPS (10 min avg) | 4,469 |
| Non-vote TPS | 1,962 |
| Slot time (measured) | 268.3 ms |
| Est. daily transactions | 396,256,147 |
...
| Metric | Value |
|---|---|
| SOL price | $116.66 (+4.7%/24h) |
| Market cap | $68.5B |
| **REV (24h)** | **$1.3M** (fees $1.1M + Jito tips $163.6K) |
| Chain TVL | $6.5B |
| Stablecoin supply | $17.1B |
| DEX volume (24h) | $3.4B (20.6%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,436,682 SOL |
| Inflation | 3.64% |
...
Crypto Fear & Greed: 78 (Extreme Greed) · CoinGecko votes bullish: 77.53% · headline tone (48h): +3
...
| solana_status_page | OK | 10830 ms |
| solana_rpc_whales | OK | 977 ms |
| solana_rpc_programs | OK | 1708 ms |
