...
> Generated 2026-09-12T09:41:41Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1033 is 33% complete (~25h remaining), with the cluster processing ~3,196 TPS (1,063 non-vote). Measured slot time is 316ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $972.3K of Real Economic Value over the last 24h ($675/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $102.10 (+3.1% / 24h). Decentralization: Nakamoto coefficient 18, 676 active validators, 0.4% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 446,397,917 |
| Block height | 424,440,718 |
| Epoch | 1033 (32.85% complete, ~25.4h left) |
| TPS (10 min avg) | 3,196 |
| Non-vote TPS | 1,063 |
| Slot time (measured) | 315.6 ms |
| Est. daily transactions | 294,269,582 |
...
| Metric | Value |
|---|---|
| SOL price | $102.10 (+3.1%/24h) |
| Market cap | $59.9B |
| **REV (24h)** | **$972.3K** (fees $835.7K + Jito tips $136.5K) |
| Chain TVL | $5.9B |
| Stablecoin supply | $16.5B |
| DEX volume (24h) | $3.2B (11.2%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 586,633,001 SOL |
| Inflation | 3.65% |
...
|---|---|---|
| solana_rpc | OK | 9183 ms |
| solana_rpc_validators | OK | 455 ms |
| coingecko | OK | 1817 ms |
| defillama_tvl | OK | 78 ms |
| defillama_dex | OK | 1142 ms |
| defillama_fees | OK | 2047 ms |
| defillama_stablecoins | OK | 743 ms |
