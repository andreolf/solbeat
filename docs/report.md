...
> Generated 2026-09-15T19:24:44Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1035 is 48% complete (~20h remaining), with the cluster processing ~4,903 TPS (2,780 non-vote). Measured slot time is 318ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $753.6K of Real Economic Value over the last 24h ($523/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $98.10 (-5.2% / 24h). Decentralization: Nakamoto coefficient 18, 679 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,328,897 |
| Block height | 425,370,658 |
| Epoch | 1035 (48.36% complete, ~19.7h left) |
| TPS (10 min avg) | 4,903 |
| Non-vote TPS | 2,780 |
| Slot time (measured) | 317.7 ms |
| Est. daily transactions | 392,114,238 |
...
| Metric | Value |
|---|---|
| SOL price | $98.10 (-5.2%/24h) |
| Market cap | $57.6B |
| **REV (24h)** | **$753.6K** (fees $647.0K + Jito tips $106.6K) |
| Chain TVL | $5.8B |
| Stablecoin supply | $16.3B |
| DEX volume (24h) | $2.5B (41.3%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,027,745 SOL |
| Inflation | 3.65% |
...
|---|---|---|
| solana_rpc | OK | 8714 ms |
| solana_rpc_validators | OK | 323 ms |
| coingecko | OK | 1823 ms |
| defillama_tvl | OK | 4676 ms |
| defillama_dex | OK | 1972 ms |
| defillama_fees | OK | 5366 ms |
