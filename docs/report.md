...
> Generated 2026-09-22T07:11:11Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1040 is 6% complete (~30h remaining), with the cluster processing ~4,170 TPS (1,621 non-vote). Measured slot time is 264ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.3M of Real Economic Value over the last 24h ($924/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $116.63 (+4.0% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 4 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 449,307,330 |
| Block height | 427,347,805 |
| Epoch | 1040 (6.33% complete, ~29.7h left) |
| TPS (10 min avg) | 4,170 |
| Non-vote TPS | 1,621 |
| Slot time (measured) | 264.4 ms |
| Est. daily transactions | 369,345,330 |
...
| Metric | Value |
|---|---|
| SOL price | $116.63 (+4.0%/24h) |
| Market cap | $68.5B |
| **REV (24h)** | **$1.3M** (fees $1.1M + Jito tips $234.6K) |
| Chain TVL | $6.4B |
| Stablecoin supply | $17.1B |
| DEX volume (24h) | $3.4B (20.6%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,508,092 SOL |
| Inflation | 3.64% |
...
Crypto Fear & Greed: 78 (Extreme Greed) · CoinGecko votes bullish: 76.19% · headline tone (48h): +2
...
|---|---|---|
| solana_rpc | OK | 8291 ms |
| solana_rpc_validators | OK | 209 ms |
| coingecko | OK | 1609 ms |
| defillama_tvl | OK | 655 ms |
| defillama_dex | OK | 909 ms |
| defillama_fees | OK | 3296 ms |
| defillama_stablecoins | OK | 843 ms |
...
| solana_rpc_whales | OK | 1046 ms |
| solana_rpc_programs | OK | 1774 ms |
