...
> Generated 2026-09-24T00:36:30Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1041 is 36% complete (~20h remaining), with the cluster processing ~4,478 TPS (1,931 non-vote). Measured slot time is 264ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.3M of Real Economic Value over the last 24h ($912/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $115.55 (-2.9% / 24h). Decentralization: Nakamoto coefficient 18, 675 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 1 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 449,867,706 |
| Block height | 427,907,847 |
| Epoch | 1041 (36.04% complete, ~20.3h left) |
| TPS (10 min avg) | 4,478 |
| Non-vote TPS | 1,931 |
| Slot time (measured) | 264.0 ms |
| Est. daily transactions | 407,087,757 |
...
| Metric | Value |
|---|---|
| SOL price | $115.55 (-2.9%/24h) |
| Market cap | $67.8B |
| **REV (24h)** | **$1.3M** (fees $1.1M + Jito tips $216.4K) |
| Chain TVL | $6.4B |
| Stablecoin supply | $16.8B |
| DEX volume (24h) | $3.1B (-3.4%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,577,666 SOL |
| Inflation | 3.63% |

Top DEXs by 24h volume: PumpSwap ($634.1M), Raydium AMM ($395.7M), BisonFi ($368.2M), Orca DEX ($366.0M), Meteora DLMM ($266.8M)
