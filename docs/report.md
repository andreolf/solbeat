...
> Generated 2026-09-15T22:05:40Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1035 is 55% complete (~17h remaining), with the cluster processing ~5,191 TPS (3,087 non-vote). Measured slot time is 320ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $751.6K of Real Economic Value over the last 24h ($522/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $96.80 (-6.2% / 24h). Decentralization: Nakamoto coefficient 18, 678 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,359,275 |
| Block height | 425,401,000 |
| Epoch | 1035 (55.39% complete, ~17.1h left) |
| TPS (10 min avg) | 5,191 |
| Non-vote TPS | 3,087 |
| Slot time (measured) | 319.6 ms |
| Est. daily transactions | 425,301,452 |
...
| Metric | Value |
|---|---|
| SOL price | $96.80 (-6.2%/24h) |
| Market cap | $56.8B |
| **REV (24h)** | **$751.6K** (fees $647.0K + Jito tips $104.6K) |
| Chain TVL | $5.7B |
| Stablecoin supply | $16.3B |
| DEX volume (24h) | $2.5B (40.2%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,027,625 SOL |
| Inflation | 3.65% |
