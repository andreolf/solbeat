...
> Generated 2026-09-17T01:17:59Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1036 is 27% complete (~28h remaining), with the cluster processing ~4,112 TPS (1,979 non-vote). Measured slot time is 316ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $829.4K of Real Economic Value over the last 24h ($576/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $98.57 (+1.6% / 24h). Decentralization: Nakamoto coefficient 18, 679 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,668,107 |
| Block height | 425,709,405 |
| Epoch | 1036 (26.88% complete, ~27.7h left) |
| TPS (10 min avg) | 4,112 |
| Non-vote TPS | 1,979 |
| Slot time (measured) | 316.2 ms |
| Est. daily transactions | 362,019,672 |
...
| Metric | Value |
|---|---|
| SOL price | $98.57 (+1.6%/24h) |
| Market cap | $57.9B |
| **REV (24h)** | **$829.4K** (fees $693.2K + Jito tips $136.1K) |
| Chain TVL | $5.7B |
| Stablecoin supply | $15.7B |
| DEX volume (24h) | $2.8B (3.4%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,212,595 SOL |
| Inflation | 3.64% |

Top DEXs by 24h volume: PumpSwap ($519.3M), BisonFi ($353.6M), fomo Wallet ($270.1M), Raydium AMM ($259.5M), Orca DEX ($256.0M)
...
| solana_rpc_programs | OK | 2786 ms |
