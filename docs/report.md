...
> Generated 2026-09-24T22:03:16Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1042 is 3% complete (~31h remaining), with the cluster processing ~4,613 TPS (2,092 non-vote). Measured slot time is 267ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.3M of Real Economic Value over the last 24h ($868/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $116.74 (+1.7% / 24h). Decentralization: Nakamoto coefficient 18, 675 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 1 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 450,158,149 |
| Block height | 428,198,166 |
| Epoch | 1042 (3.28% complete, ~31.0h left) |
| TPS (10 min avg) | 4,613 |
| Non-vote TPS | 2,092 |
| Slot time (measured) | 266.7 ms |
| Est. daily transactions | 409,620,656 |
...
| Metric | Value |
|---|---|
| SOL price | $116.74 (+1.7%/24h) |
| Market cap | $68.7B |
| **REV (24h)** | **$1.3M** (fees $1.0M + Jito tips $239.1K) |
| Chain TVL | $6.5B |
| Stablecoin supply | $16.4B |
| DEX volume (24h) | $2.6B (-20.1%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,648,370 SOL |
| Inflation | 3.63% |
...
|---|---|---|
| solana_rpc | OK | 6585 ms |
| solana_rpc_validators | OK | 249 ms |
...
| solana_rpc_programs | OK | 1838 ms |
