...
> Generated 2026-09-25T13:36:47Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1042 is 52% complete (~16h remaining), with the cluster processing ~4,768 TPS (2,273 non-vote). Measured slot time is 269ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.2M of Real Economic Value over the last 24h ($830/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $119.50 (+4.0% / 24h). Decentralization: Nakamoto coefficient 18, 675 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 3 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 450,368,034 |
| Block height | 428,407,934 |
| Epoch | 1042 (51.86% complete, ~15.5h left) |
| TPS (10 min avg) | 4,768 |
| Non-vote TPS | 2,273 |
| Slot time (measured) | 268.9 ms |
| Est. daily transactions | 365,901,149 |
...
| Circulating supply | 587,647,587 SOL |
| Inflation | 3.63% |
...
Crypto Fear & Greed: 71 (Greed) · CoinGecko votes bullish: 88.52% · headline tone (48h): +4
