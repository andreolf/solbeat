...
> Generated 2026-09-15T19:55:20Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1035 is 50% complete (~19h remaining), with the cluster processing ~4,813 TPS (2,671 non-vote). Measured slot time is 316ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $753.9K of Real Economic Value over the last 24h ($524/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $97.68 (-5.2% / 24h). Decentralization: Nakamoto coefficient 18, 679 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,334,694 |
| Block height | 425,376,455 |
| Epoch | 1035 (49.7% complete, ~19.1h left) |
| TPS (10 min avg) | 4,813 |
| Non-vote TPS | 2,671 |
| Slot time (measured) | 315.7 ms |
| Est. daily transactions | 396,319,524 |
...
| Metric | Value |
|---|---|
| SOL price | $97.68 (-5.2%/24h) |
| Market cap | $57.3B |
| **REV (24h)** | **$753.9K** (fees $647.0K + Jito tips $106.8K) |
| Chain TVL | $5.8B |
| Stablecoin supply | $16.3B |
| DEX volume (24h) | $2.5B (41.3%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,027,722 SOL |
| Inflation | 3.65% |
...
Crypto Fear & Greed: 69 (Greed) · CoinGecko votes bullish: 67.74% · headline tone (48h): +2
...
| solana_rpc_programs | OK | 5883 ms |
