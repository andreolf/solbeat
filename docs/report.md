...
> Generated 2026-09-21T20:01:19Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1039 is 71% complete (~9h remaining), with the cluster processing ~4,886 TPS (2,367 non-vote). Measured slot time is 267ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $953.5K of Real Economic Value over the last 24h ($662/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $118.24 (+7.1% / 24h). Decentralization: Nakamoto coefficient 18, 676 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 3 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 449,156,740 |
| Block height | 427,197,336 |
| Epoch | 1039 (71.47% complete, ~9.1h left) |
| TPS (10 min avg) | 4,886 |
| Non-vote TPS | 2,367 |
| Slot time (measured) | 267.2 ms |
| Est. daily transactions | 430,242,253 |
...
| Circulating supply | 587,437,036 SOL |
| Inflation | 3.64% |
...
Crypto Fear & Greed: 70 (Greed) · CoinGecko votes bullish: 83.78% · headline tone (48h): +5
...
|---|---|---|
| solana_rpc | OK | 9000 ms |
| solana_rpc_validators | OK | 551 ms |
| coingecko | OK | 1662 ms |
| defillama_tvl | OK | 48 ms |
| defillama_dex | OK | 1185 ms |
| defillama_fees | OK | 2070 ms |
...
| solana_rpc_whales | OK | 1443 ms |
| solana_rpc_programs | OK | 2592 ms |
