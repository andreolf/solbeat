...
> Generated 2026-09-21T18:29:48Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1039 is 67% complete (~11h remaining), with the cluster processing ~4,757 TPS (2,227 non-vote). Measured slot time is 266ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $953.2K of Real Economic Value over the last 24h ($662/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $117.42 (+6.5% / 24h). Decentralization: Nakamoto coefficient 18, 676 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 3 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 449,136,265 |
| Block height | 427,176,873 |
| Epoch | 1039 (66.73% complete, ~10.6h left) |
| TPS (10 min avg) | 4,757 |
| Non-vote TPS | 2,227 |
| Slot time (measured) | 265.8 ms |
| Est. daily transactions | 440,706,280 |
...
| Metric | Value |
|---|---|
| SOL price | $117.42 (+6.5%/24h) |
| Market cap | $69.0B |
| **REV (24h)** | **$953.2K** (fees $787.0K + Jito tips $166.2K) |
| Chain TVL | $6.5B |
| Stablecoin supply | $15.8B |
| DEX volume (24h) | $2.8B (-2.8%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,437,106 SOL |
| Inflation | 3.64% |

Top DEXs by 24h volume: PumpSwap ($482.8M), Raydium AMM ($454.8M), BisonFi ($424.3M), Orca DEX ($301.6M), HumidiFi ($253.1M)
...
Crypto Fear & Greed: 70 (Greed) · CoinGecko votes bullish: 81.16% · headline tone (48h): +4
...
| solana_rpc_whales | OK | 949 ms |
| solana_rpc_programs | OK | 1735 ms |
