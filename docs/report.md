...
> Generated 2026-09-12T02:08:21Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1033 is 13% complete (~33h remaining), with the cluster processing ~3,764 TPS (1,647 non-vote). Measured slot time is 318ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $844.4K of Real Economic Value over the last 24h ($586/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $101.91 (+2.6% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.4% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 446,312,085 |
| Block height | 424,354,917 |
| Epoch | 1033 (12.98% complete, ~33.2h left) |
| TPS (10 min avg) | 3,764 |
| Non-vote TPS | 1,647 |
| Slot time (measured) | 318.4 ms |
| Est. daily transactions | 355,138,327 |
...
| Metric | Value |
|---|---|
| SOL price | $101.91 (+2.6%/24h) |
| Market cap | $59.8B |
| **REV (24h)** | **$844.4K** (fees $709.3K + Jito tips $135.1K) |
| Chain TVL | $5.9B |
| Stablecoin supply | $16.5B |
| DEX volume (24h) | $3.2B (11.2%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 586,633,250 SOL |
| Inflation | 3.65% |
...
Crypto Fear & Greed: 63 (Greed) · CoinGecko votes bullish: 79.41% · headline tone (48h): +3
...
|---|---|---|
| solana_rpc | OK | 10030 ms |
| solana_rpc_validators | OK | 830 ms |
| coingecko | OK | 1711 ms |
| defillama_tvl | OK | 191 ms |
| defillama_dex | OK | 1175 ms |
| defillama_fees | OK | 1375 ms |
...
| solana_rpc_whales | OK | 2008 ms |
| solana_rpc_programs | OK | 3432 ms |
