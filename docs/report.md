...
> Generated 2026-08-31T18:40:48Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1025 is 98% complete (~1h remaining), with the cluster processing ~4,322 TPS (2,196 non-vote). Measured slot time is 318ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $857.1K of Real Economic Value over the last 24h ($595/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $104.44 (-2.1% / 24h). Decentralization: Nakamoto coefficient 18, 681 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 1 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 443,221,746 |
| Block height | 421,269,395 |
| Epoch | 1025 (97.63% complete, ~0.9h left) |
| TPS (10 min avg) | 4,322 |
| Non-vote TPS | 2,196 |
| Slot time (measured) | 318.3 ms |
| Est. daily transactions | 394,980,293 |
...
| Metric | Value |
|---|---|
| SOL price | $104.44 (-2.1%/24h) |
| Market cap | $61.1B |
| **REV (24h)** | **$857.1K** (fees $677.1K + Jito tips $180.1K) |
| Chain TVL | $5.8B |
| Stablecoin supply | $16.1B |
| DEX volume (24h) | $1.9B (15.5%/1d) |
| Tokenized equities (xStocks TVL) | $440.3M |
| Circulating supply | 585,120,762 SOL |
| Inflation | 3.67% |
...
| Binance (cold) | 1,694,278 |
| OKX (attributed) | 334,301 |
| Coinbase (hot) | 29,678 |
