...
> Generated 2026-08-31T22:37:34Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1026 is 8% complete (~35h remaining), with the cluster processing ~3,683 TPS (1,538 non-vote). Measured slot time is 316ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $824.8K of Real Economic Value over the last 24h ($573/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $103.31 (-0.2% / 24h). Decentralization: Nakamoto coefficient 18, 681 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 4 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 443,266,482 |
| Block height | 421,314,097 |
| Epoch | 1026 (7.98% complete, ~34.9h left) |
| TPS (10 min avg) | 3,683 |
| Non-vote TPS | 1,538 |
| Slot time (measured) | 316.2 ms |
| Est. daily transactions | 361,462,172 |
...
| Metric | Value |
|---|---|
| SOL price | $103.31 (-0.2%/24h) |
| Market cap | $60.5B |
| **REV (24h)** | **$824.8K** (fees $677.1K + Jito tips $147.7K) |
| Chain TVL | $5.9B |
| Stablecoin supply | $16.1B |
| DEX volume (24h) | $1.9B (15.5%/1d) |
| Tokenized equities (xStocks TVL) | $442.4M |
| Circulating supply | 585,207,038 SOL |
| Inflation | 3.67% |

Top DEXs by 24h volume: PumpSwap ($732.1M), Orca DEX ($264.7M), BisonFi ($184.5M), Meteora DLMM ($142.7M), Raydium AMM ($141.1M)
...
Crypto Fear & Greed: 62 (Greed) · CoinGecko votes bullish: 70.0% · headline tone (48h): +4
...
| Binance (cold) | 1,788,503 |
| OKX (attributed) | 326,979 |
| Coinbase (hot) | 30,908 |
...
|---|---|---|
| solana_rpc | OK | 7172 ms |
| solana_rpc_validators | OK | 132 ms |
| coingecko | OK | 1729 ms |
| defillama_tvl | OK | 134 ms |
| defillama_dex | OK | 1245 ms |
| defillama_fees | OK | 2017 ms |
| defillama_stablecoins | OK | 1312 ms |
| defillama_xstocks | OK | 2116 ms |
| jito_kobe | OK | 286 ms |
| stakewiz | OK | 1384 ms |
| github | OK | 943 ms |
