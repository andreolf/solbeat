...
> Generated 2026-09-12T06:28:52Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1033 is 24% complete (~29h remaining), with the cluster processing ~3,286 TPS (1,183 non-vote). Measured slot time is 317ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $971.0K of Real Economic Value over the last 24h ($674/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $101.71 (+2.1% / 24h). Decentralization: Nakamoto coefficient 18, 674 active validators, 0.5% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 446,361,377 |
| Block height | 424,404,197 |
| Epoch | 1033 (24.39% complete, ~28.8h left) |
| TPS (10 min avg) | 3,286 |
| Non-vote TPS | 1,183 |
| Slot time (measured) | 317.4 ms |
| Est. daily transactions | 314,578,519 |
...
| Metric | Value |
|---|---|
| SOL price | $101.71 (+2.1%/24h) |
| Market cap | $59.7B |
| **REV (24h)** | **$971.0K** (fees $835.7K + Jito tips $135.3K) |
| Chain TVL | $5.9B |
| Stablecoin supply | $16.5B |
| DEX volume (24h) | $3.2B (11.2%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 586,633,100 SOL |
| Inflation | 3.65% |

Top DEXs by 24h volume: Raydium AMM ($511.3M), BisonFi ($395.8M), Meteora DLMM ($363.0M), HumidiFi ($322.7M), PumpSwap ($294.2M)
...
Crypto Fear & Greed: 63 (Greed) · CoinGecko votes bullish: 87.1% · headline tone (48h): +2
...
|---|---|---|
| solana_rpc | OK | 9546 ms |
| solana_rpc_validators | OK | 586 ms |
| coingecko | OK | 1726 ms |
| defillama_tvl | OK | 8545 ms |
| defillama_dex | OK | 4390 ms |
| defillama_fees | OK | 2188 ms |
...
| solana_rpc_whales | OK | 1475 ms |
| solana_rpc_programs | OK | 2578 ms |
