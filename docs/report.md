...
> Generated 2026-09-16T22:51:13Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1036 is 20% complete (~30h remaining), with the cluster processing ~4,132 TPS (2,010 non-vote). Measured slot time is 318ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $827.2K of Real Economic Value over the last 24h ($574/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $97.54 (+0.5% / 24h). Decentralization: Nakamoto coefficient 18, 678 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,640,345 |
| Block height | 425,681,663 |
| Epoch | 1036 (20.45% complete, ~30.4h left) |
| TPS (10 min avg) | 4,132 |
| Non-vote TPS | 2,010 |
| Slot time (measured) | 318.0 ms |
| Est. daily transactions | 396,312,462 |
...
| Metric | Value |
|---|---|
| SOL price | $97.54 (+0.5%/24h) |
| Market cap | $57.3B |
| **REV (24h)** | **$827.2K** (fees $693.2K + Jito tips $134.0K) |
| Chain TVL | $5.7B |
| Stablecoin supply | $15.9B |
| DEX volume (24h) | $2.7B (6.8%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,150,190 SOL |
| Inflation | 3.64% |
...
Crypto Fear & Greed: 51 (Neutral) · CoinGecko votes bullish: 68.57% · headline tone (48h): +2
...
| solana_rpc_whales | OK | 777 ms |
| solana_rpc_programs | OK | 1664 ms |
