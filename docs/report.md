...
> Generated 2026-09-18T14:21:06Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1037 is 29% complete (~23h remaining), with the cluster processing ~5,112 TPS (2,592 non-vote). Measured slot time is 268ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.1M of Real Economic Value over the last 24h ($729/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $109.05 (+7.9% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 448,108,871 |
| Block height | 426,149,822 |
| Epoch | 1037 (28.91% complete, ~22.8h left) |
| TPS (10 min avg) | 5,112 |
| Non-vote TPS | 2,592 |
| Slot time (measured) | 267.6 ms |
| Est. daily transactions | 376,386,284 |
...
| Metric | Value |
|---|---|
| SOL price | $109.05 (+7.9%/24h) |
| Market cap | $64.0B |
| **REV (24h)** | **$1.1M** (fees $813.1K + Jito tips $236.9K) |
| Chain TVL | $6.0B |
| Stablecoin supply | $15.6B |
| DEX volume (24h) | $2.6B (-7.4%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,297,150 SOL |
| Inflation | 3.64% |
...
Crypto Fear & Greed: 56 (Greed) · CoinGecko votes bullish: 75.44% · headline tone (48h): -1
...
| defillama_dex | OK | 7801 ms |
| defillama_fees | OK | 119 ms |
| defillama_stablecoins | OK | 103 ms |
| defillama_xstocks | OK | 2734 ms |
| jito_kobe | OK | 220 ms |
| stakewiz | OK | 1336 ms |
| github | OK | 718 ms |
