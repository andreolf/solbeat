...
> Generated 2026-09-25T19:30:37Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1042 is 70% complete (~10h remaining), with the cluster processing ~4,466 TPS (1,951 non-vote). Measured slot time is 268ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.2M of Real Economic Value over the last 24h ($834/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $121.75 (+3.5% / 24h). Decentralization: Nakamoto coefficient 18, 676 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 3 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 450,447,125 |
| Block height | 428,487,001 |
| Epoch | 1042 (70.17% complete, ~9.6h left) |
| TPS (10 min avg) | 4,466 |
| Non-vote TPS | 1,951 |
| Slot time (measured) | 267.8 ms |
| Est. daily transactions | 418,468,553 |
...
| Metric | Value |
|---|---|
| SOL price | $121.75 (+3.5%/24h) |
| Market cap | $71.5B |
| **REV (24h)** | **$1.2M** (fees $952.7K + Jito tips $248.4K) |
| Chain TVL | $6.6B |
| Stablecoin supply | $17.6B |
| DEX volume (24h) | $2.5B (-4%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,642,099 SOL |
| Inflation | 3.63% |

Top DEXs by 24h volume: BisonFi ($395.1M), Orca DEX ($344.6M), Raydium AMM ($310.7M), Meteora DLMM ($191.0M), HumidiFi ($190.3M)
...
Crypto Fear & Greed: 71 (Greed) · CoinGecko votes bullish: 90.54% · headline tone (48h): +5
...
| defillama_xstocks | OK | 726 ms |
| jito_kobe | OK | 351 ms |
| stakewiz | OK | 1284 ms |
| github | OK | 799 ms |
| solana_com_news | OK | 238 ms |
| sentiment | OK | 2342 ms |
| solana_status_page | OK | 555 ms |
| solana_rpc_whales | OK | 1263 ms |
| solana_rpc_programs | OK | 2450 ms |
