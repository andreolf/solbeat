...
> Generated 2026-09-16T06:54:31Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1035 is 79% complete (~8h remaining), with the cluster processing ~3,392 TPS (1,255 non-vote). Measured slot time is 315ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $799.6K of Real Economic Value over the last 24h ($555/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $97.10 (-3.7% / 24h). Decentralization: Nakamoto coefficient 18, 678 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,459,245 |
| Block height | 425,500,744 |
| Epoch | 1035 (78.53% complete, ~8.1h left) |
| TPS (10 min avg) | 3,392 |
| Non-vote TPS | 1,255 |
| Slot time (measured) | 315.1 ms |
| Est. daily transactions | 334,980,166 |
...
| Circulating supply | 587,064,778 SOL |
| Inflation | 3.65% |
...
Crypto Fear & Greed: 51 (Neutral) · CoinGecko votes bullish: 68.97% · headline tone (48h): +2
...
| solana_rpc_whales | OK | 2396 ms |
| solana_rpc_programs | OK | 4400 ms |
