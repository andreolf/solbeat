...
> Generated 2026-09-20T04:31:09Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1038 is 48% complete (~17h remaining), with the cluster processing ~3,761 TPS (1,229 non-vote). Measured slot time is 267ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $980.9K of Real Economic Value over the last 24h ($681/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $108.89 (-3.6% / 24h). Decentralization: Nakamoto coefficient 18, 679 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 1 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 448,624,010 |
| Block height | 426,664,734 |
| Epoch | 1038 (48.15% complete, ~16.6h left) |
| TPS (10 min avg) | 3,761 |
| Non-vote TPS | 1,229 |
| Slot time (measured) | 267.1 ms |
| Est. daily transactions | 369,502,202 |
...
| Circulating supply | 587,367,129 SOL |
| Inflation | 3.64% |
...
Crypto Fear & Greed: 71 (Greed) · CoinGecko votes bullish: 72.88% · headline tone (48h): +5
...
| defillama_fees | OK | 1073 ms |
| defillama_stablecoins | OK | 1219 ms |
| defillama_xstocks | OK | 819 ms |
| jito_kobe | OK | 307 ms |
| stakewiz | OK | 1112 ms |
| github | OK | 939 ms |
