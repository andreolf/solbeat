...
> Generated 2026-09-10T15:42:48Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1032 is 22% complete (~29h remaining), with the cluster processing ~4,071 TPS (1,935 non-vote). Measured slot time is 315ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.1M of Real Economic Value over the last 24h ($794/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $99.69 (-3.3% / 24h). Decentralization: Nakamoto coefficient 18, 676 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 445,920,856 |
| Block height | 423,964,211 |
| Epoch | 1032 (22.42% complete, ~29.3h left) |
| TPS (10 min avg) | 4,071 |
| Non-vote TPS | 1,935 |
| Slot time (measured) | 315.1 ms |
| Est. daily transactions | 362,441,627 |
...
| Circulating supply | 586,335,517 SOL |
| Inflation | 3.65% |
...
Crypto Fear & Greed: 69 (Greed) · CoinGecko votes bullish: 67.5% · headline tone (48h): +0
...
|---|---|---|
| solana_rpc | OK | 8937 ms |
| solana_rpc_validators | OK | 176 ms |
| coingecko | OK | 1617 ms |
| defillama_tvl | OK | 727 ms |
| defillama_dex | OK | 208 ms |
| defillama_fees | OK | 3237 ms |
| defillama_stablecoins | OK | 500 ms |
| defillama_xstocks | OK | 267 ms |
| jito_kobe | OK | 281 ms |
| stakewiz | OK | 1964 ms |
| github | OK | 825 ms |
| solana_com_news | OK | 77 ms |
| sentiment | OK | 2266 ms |
| solana_status_page | OK | 299 ms |
| solana_rpc_whales | OK | 950 ms |
| solana_rpc_programs | OK | 1672 ms |
