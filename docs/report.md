...
> Generated 2026-09-17T23:35:46Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1036 is 86% complete (~6h remaining), with the cluster processing ~4,127 TPS (1,988 non-vote). Measured slot time is 315ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $891.1K of Real Economic Value over the last 24h ($619/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $101.41 (+3.1% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,921,406 |
| Block height | 425,962,506 |
| Epoch | 1036 (85.51% complete, ~5.5h left) |
| TPS (10 min avg) | 4,127 |
| Non-vote TPS | 1,988 |
| Slot time (measured) | 315.2 ms |
| Est. daily transactions | 385,251,242 |
...
| Metric | Value |
|---|---|
| SOL price | $101.41 (+3.1%/24h) |
| Market cap | $59.6B |
| **REV (24h)** | **$891.1K** (fees $750.6K + Jito tips $140.5K) |
| Chain TVL | $5.9B |
| Stablecoin supply | $15.7B |
| DEX volume (24h) | $2.8B (3.6%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,211,708 SOL |
| Inflation | 3.64% |

Top DEXs by 24h volume: PumpSwap ($441.4M), BisonFi ($440.1M), HumidiFi ($301.8M), Raydium AMM ($275.1M), fomo Wallet ($212.9M)
...
|---|---|---|
| solana_rpc | OK | 12196 ms |
| solana_rpc_validators | OK | 1270 ms |
| coingecko | OK | 1667 ms |
| defillama_tvl | OK | 171 ms |
| defillama_dex | OK | 900 ms |
| defillama_fees | OK | 1511 ms |
| defillama_stablecoins | OK | 601 ms |
| defillama_xstocks | OK | 643 ms |
| jito_kobe | OK | 287 ms |
| stakewiz | OK | 1175 ms |
| github | OK | 851 ms |
...
| solana_rpc_whales | OK | 2785 ms |
| solana_rpc_programs | OK | 5369 ms |
