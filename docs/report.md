...
| Health | ok |
| Slot | 447,797,140 |
| Block height | 425,838,324 |
| Epoch | 1036 (56.75% complete, ~16.5h left) |
| TPS (10 min avg) | 4,011 |
| Non-vote TPS | 1,907 |
| Slot time (measured) | 318.7 ms |
| Est. daily transactions | 318,148,468 |
...
| Circulating supply | 587,212,177 SOL |
| Inflation | 3.64% |
