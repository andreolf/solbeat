...
> Generated 2026-09-25T15:38:12Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1042 is 58% complete (~14h remaining), with the cluster processing ~4,999 TPS (2,498 non-vote). Measured slot time is 269ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.2M of Real Economic Value over the last 24h ($831/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $119.93 (+3.0% / 24h). Decentralization: Nakamoto coefficient 18, 675 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 3 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 450,395,183 |
| Block height | 428,435,067 |
| Epoch | 1042 (58.14% complete, ~13.5h left) |
| TPS (10 min avg) | 4,999 |
| Non-vote TPS | 2,498 |
| Slot time (measured) | 269.0 ms |
| Est. daily transactions | 405,417,830 |
...
| Metric | Value |
|---|---|
| SOL price | $119.93 (+3.0%/24h) |
| Market cap | $70.5B |
| **REV (24h)** | **$1.2M** (fees $952.7K + Jito tips $243.6K) |
| Chain TVL | $6.5B |
| Stablecoin supply | $17.6B |
| DEX volume (24h) | $2.5B (-4%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,647,492 SOL |
| Inflation | 3.63% |
...
Crypto Fear & Greed: 71 (Greed) · CoinGecko votes bullish: 90.91% · headline tone (48h): +4
...
|---|---|---|
| solana_rpc | OK | 8045 ms |
| solana_rpc_validators | OK | 159 ms |
| coingecko | OK | 1612 ms |
