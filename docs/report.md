...
> Generated 2026-09-15T22:36:04Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1035 is 57% complete (~17h remaining), with the cluster processing ~5,111 TPS (3,023 non-vote). Measured slot time is 322ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $750.7K of Real Economic Value over the last 24h ($521/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $96.71 (-6.2% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,364,966 |
| Block height | 425,406,658 |
| Epoch | 1035 (56.71% complete, ~16.7h left) |
| TPS (10 min avg) | 5,111 |
| Non-vote TPS | 3,023 |
| Slot time (measured) | 322.1 ms |
| Est. daily transactions | 424,978,896 |
...
| Metric | Value |
|---|---|
| SOL price | $96.71 (-6.2%/24h) |
| Market cap | $56.8B |
| **REV (24h)** | **$750.7K** (fees $647.0K + Jito tips $103.7K) |
| Chain TVL | $5.7B |
| Stablecoin supply | $16.3B |
| DEX volume (24h) | $2.5B (40.2%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,027,601 SOL |
| Inflation | 3.65% |

Top DEXs by 24h volume: PumpSwap ($445.4M), BisonFi ($315.8M), Raydium AMM ($258.9M), Meteora DLMM ($198.8M), Orca DEX ($193.0M)
...
Crypto Fear & Greed: 69 (Greed) · CoinGecko votes bullish: 73.08% · headline tone (48h): +2
...
|---|---|---|
| solana_rpc | OK | 9116 ms |
| solana_rpc_validators | OK | 117 ms |
| coingecko | OK | 1713 ms |
| defillama_tvl | OK | 74 ms |
| defillama_dex | OK | 419 ms |
| defillama_fees | OK | 732 ms |
| defillama_stablecoins | OK | 113 ms |
| defillama_xstocks | OK | 529 ms |
| jito_kobe | OK | 248 ms |
| stakewiz | OK | 933 ms |
| github | OK | 583 ms |
...
| solana_rpc_programs | OK | 5477 ms |
