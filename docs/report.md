...
> Generated 2026-09-25T15:07:52Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1042 is 57% complete (~14h remaining), with the cluster processing ~5,010 TPS (2,492 non-vote). Measured slot time is 267ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.2M of Real Economic Value over the last 24h ($833/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $120.23 (+4.7% / 24h). Decentralization: Nakamoto coefficient 18, 675 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 3 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 450,388,397 |
| Block height | 428,428,281 |
| Epoch | 1042 (56.57% complete, ~13.9h left) |
| TPS (10 min avg) | 5,010 |
| Non-vote TPS | 2,492 |
| Slot time (measured) | 266.7 ms |
| Est. daily transactions | 397,288,633 |
...
| Circulating supply | 587,647,515 SOL |
| Inflation | 3.63% |
...
Crypto Fear & Greed: 71 (Greed) · CoinGecko votes bullish: 89.86% · headline tone (48h): +4
...
| solana_rpc_programs | OK | 1370 ms |
