...
> Generated 2026-09-21T14:08:55Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1039 is 53% complete (~15h remaining), with the cluster processing ~5,457 TPS (2,971 non-vote). Measured slot time is 271ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $950.3K of Real Economic Value over the last 24h ($660/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $117.62 (+8.4% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 4 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 449,077,911 |
| Block height | 427,118,530 |
| Epoch | 1039 (53.22% complete, ~15.2h left) |
| TPS (10 min avg) | 5,457 |
| Non-vote TPS | 2,971 |
| Slot time (measured) | 270.9 ms |
| Est. daily transactions | 384,303,444 |
...
| Metric | Value |
|---|---|
| SOL price | $117.62 (+8.4%/24h) |
| Market cap | $69.2B |
| **REV (24h)** | **$950.3K** (fees $787.0K + Jito tips $163.3K) |
| Chain TVL | $6.4B |
| Stablecoin supply | $15.8B |
| DEX volume (24h) | $2.8B (-2.8%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,437,317 SOL |
| Inflation | 3.64% |
...
- **[WARNING]** TPS spike: 5,457 vs 12h mean 4,411 (z=+2.3)
