...
> Generated 2026-09-15T07:45:34Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1035 is 18% complete (~31h remaining), with the cluster processing ~3,463 TPS (1,322 non-vote). Measured slot time is 316ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $757.0K of Real Economic Value over the last 24h ($526/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $100.66 (-0.9% / 24h). Decentralization: Nakamoto coefficient 18, 679 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,196,185 |
| Block height | 425,238,117 |
| Epoch | 1035 (17.64% complete, ~31.2h left) |
| TPS (10 min avg) | 3,463 |
| Non-vote TPS | 1,322 |
| Slot time (measured) | 316.0 ms |
| Est. daily transactions | 312,453,618 |
...
| Metric | Value |
|---|---|
| SOL price | $100.66 (-0.9%/24h) |
| Market cap | $59.1B |
| **REV (24h)** | **$757.0K** (fees $647.0K + Jito tips $110.0K) |
| Chain TVL | $5.9B |
| Stablecoin supply | $16.3B |
| DEX volume (24h) | $2.2B (23.6%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,028,188 SOL |
| Inflation | 3.65% |

Top DEXs by 24h volume: PumpSwap ($445.4M), Raydium AMM ($288.4M), BisonFi ($201.5M), Meteora DLMM ($198.8M), fomo Wallet ($183.8M)
...
|---|---|---|
| solana_rpc | OK | 9149 ms |
| solana_rpc_validators | OK | 441 ms |
| coingecko | OK | 1657 ms |
| defillama_tvl | OK | 96 ms |
| defillama_dex | OK | 901 ms |
| defillama_fees | OK | 1579 ms |
| defillama_stablecoins | OK | 596 ms |
| defillama_xstocks | OK | 590 ms |
| jito_kobe | OK | 235 ms |
| stakewiz | OK | 825 ms |
| github | OK | 783 ms |
