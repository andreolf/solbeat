...
> Generated 2026-09-11T03:28:03Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1032 is 53% complete (~18h remaining), with the cluster processing ~3,823 TPS (1,690 non-vote). Measured slot time is 316ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $873.6K of Real Economic Value over the last 24h ($607/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $99.05 (-2.6% / 24h). Decentralization: Nakamoto coefficient 18, 676 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 446,054,540 |
| Block height | 424,097,839 |
| Epoch | 1032 (53.37% complete, ~17.7h left) |
| TPS (10 min avg) | 3,823 |
| Non-vote TPS | 1,690 |
| Slot time (measured) | 315.5 ms |
| Est. daily transactions | 333,352,029 |
...
| Metric | Value |
|---|---|
| SOL price | $99.05 (-2.6%/24h) |
| Market cap | $58.1B |
| **REV (24h)** | **$873.6K** (fees $709.3K + Jito tips $164.2K) |
| Chain TVL | $5.8B |
| Stablecoin supply | $16.3B |
| DEX volume (24h) | $2.9B (-1.7%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 586,537,780 SOL |
| Inflation | 3.65% |
...
| solana_rpc_whales | OK | 769 ms |
| solana_rpc_programs | OK | 1342 ms |
