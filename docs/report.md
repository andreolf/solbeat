...
> Generated 2026-09-25T19:00:07Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1042 is 69% complete (~10h remaining), with the cluster processing ~4,324 TPS (1,816 non-vote). Measured slot time is 268ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.2M of Real Economic Value over the last 24h ($834/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $121.90 (+3.9% / 24h). Decentralization: Nakamoto coefficient 18, 676 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 4 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 450,440,292 |
| Block height | 428,480,168 |
| Epoch | 1042 (68.59% complete, ~10.1h left) |
| TPS (10 min avg) | 4,324 |
| Non-vote TPS | 1,816 |
| Slot time (measured) | 268.5 ms |
| Est. daily transactions | 423,905,033 |
...
| Metric | Value |
|---|---|
| SOL price | $121.90 (+3.9%/24h) |
| Market cap | $71.6B |
| **REV (24h)** | **$1.2M** (fees $952.7K + Jito tips $248.0K) |
| Chain TVL | $6.6B |
| Stablecoin supply | $17.6B |
| DEX volume (24h) | $2.5B (-4%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,642,121 SOL |
| Inflation | 3.63% |

Top DEXs by 24h volume: BisonFi ($395.1M), Orca DEX ($344.6M), Raydium AMM ($302.5M), Meteora DLMM ($191.0M), HumidiFi ($190.3M)
...
- **[WARNING]** TPS drop: 4,324 vs 12h mean 4,934 (z=-2.2)
...
Crypto Fear & Greed: 71 (Greed) · CoinGecko votes bullish: 90.41% · headline tone (48h): +6
...
|---|---|---|
| solana_rpc | OK | 8799 ms |
| solana_rpc_validators | OK | 508 ms |
| coingecko | OK | 1675 ms |
| defillama_tvl | OK | 140 ms |
| defillama_dex | OK | 989 ms |
| defillama_fees | OK | 6199 ms |
| defillama_stablecoins | OK | 197 ms |
| defillama_xstocks | OK | 66 ms |
| jito_kobe | OK | 435 ms |
| stakewiz | OK | 965 ms |
| github | OK | 804 ms |
| solana_com_news | OK | 254 ms |
| sentiment | OK | 2291 ms |
| solana_status_page | OK | 429 ms |
| solana_rpc_whales | OK | 1250 ms |
