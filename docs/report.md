...
| Health | ok |
| Slot | 446,934,691 |
| Block height | 424,977,212 |
| Epoch | 1034 (57.1% complete, ~16.3h left) |
| TPS (10 min avg) | 3,420 |
| Non-vote TPS | 1,283 |
| Slot time (measured) | 315.7 ms |
| Est. daily transactions | 303,917,775 |
...
| Circulating supply | 586,892,886 SOL |
| Inflation | 3.65% |
