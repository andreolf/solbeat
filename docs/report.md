...
> Generated 2026-09-20T05:01:32Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1038 is 50% complete (~16h remaining), with the cluster processing ~3,960 TPS (1,424 non-vote). Measured slot time is 266ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $981.6K of Real Economic Value over the last 24h ($682/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $109.07 (-2.9% / 24h). Decentralization: Nakamoto coefficient 18, 678 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 1 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 448,630,855 |
| Block height | 426,671,579 |
| Epoch | 1038 (49.73% complete, ~16.1h left) |
| TPS (10 min avg) | 3,960 |
| Non-vote TPS | 1,424 |
| Slot time (measured) | 266.2 ms |
| Est. daily transactions | 364,952,203 |
...
| Metric | Value |
|---|---|
| SOL price | $109.07 (-2.9%/24h) |
| Market cap | $64.1B |
| **REV (24h)** | **$981.6K** (fees $826.3K + Jito tips $155.4K) |
| Chain TVL | $6.2B |
| Stablecoin supply | $15.7B |
| DEX volume (24h) | $3.2B (-8.6%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,367,110 SOL |
| Inflation | 3.64% |
...
| solana_rpc_programs | OK | 1494 ms |
