...
> Generated 2026-09-18T18:18:03Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1037 is 41% complete (~19h remaining), with the cluster processing ~5,002 TPS (2,502 non-vote). Measured slot time is 269ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.1M of Real Economic Value over the last 24h ($733/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $112.36 (+10.8% / 24h). Decentralization: Nakamoto coefficient 18, 676 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 3 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 448,162,070 |
| Block height | 426,203,001 |
| Epoch | 1037 (41.22% complete, ~19.0h left) |
| TPS (10 min avg) | 5,002 |
| Non-vote TPS | 2,502 |
| Slot time (measured) | 269.4 ms |
| Est. daily transactions | 442,760,796 |
...
| Metric | Value |
|---|---|
| SOL price | $112.36 (+10.8%/24h) |
| Market cap | $66.0B |
| **REV (24h)** | **$1.1M** (fees $813.1K + Jito tips $242.5K) |
| Chain TVL | $6.2B |
| Stablecoin supply | $15.6B |
| DEX volume (24h) | $2.6B (-7.4%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,296,959 SOL |
| Inflation | 3.64% |
...
Crypto Fear & Greed: 56 (Greed) · CoinGecko votes bullish: 79.45% · headline tone (48h): +2
