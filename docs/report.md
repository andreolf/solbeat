...
> Generated 2026-09-22T23:00:24Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1040 is 56% complete (~14h remaining), with the cluster processing ~4,457 TPS (1,957 non-vote). Measured slot time is 270ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.3M of Real Economic Value over the last 24h ($923/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $118.51 (-0.7% / 24h). Decentralization: Nakamoto coefficient 18, 678 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 6 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 449,520,492 |
| Block height | 427,560,815 |
| Epoch | 1040 (55.67% complete, ~14.3h left) |
| TPS (10 min avg) | 4,457 |
| Non-vote TPS | 1,957 |
| Slot time (measured) | 269.6 ms |
| Est. daily transactions | 400,730,884 |
...
| Metric | Value |
|---|---|
| SOL price | $118.51 (-0.7%/24h) |
| Market cap | $69.6B |
| **REV (24h)** | **$1.3M** (fees $1.1M + Jito tips $233.8K) |
| Chain TVL | $6.5B |
| Stablecoin supply | $17.1B |
| DEX volume (24h) | $3.4B (22.7%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,507,313 SOL |
| Inflation | 3.64% |
...
Crypto Fear & Greed: 78 (Extreme Greed) · CoinGecko votes bullish: 75.0% · headline tone (48h): +6
