...
| Health | ok |
| Slot | 446,563,009 |
| Block height | 424,605,737 |
| Epoch | 1033 (71.07% complete, ~11.0h left) |
| TPS (10 min avg) | 3,619 |
| Non-vote TPS | 1,488 |
| Slot time (measured) | 316.2 ms |
| Est. daily transactions | 332,731,411 |
...
| Circulating supply | 586,644,987 SOL |
| Inflation | 3.65% |
