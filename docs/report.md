...
> Generated 2026-09-15T03:23:41Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1035 is 6% complete (~35h remaining), with the cluster processing ~3,938 TPS (1,825 non-vote). Measured slot time is 314ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $719.5K of Real Economic Value over the last 24h ($500/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $101.42 (+0.2% / 24h). Decentralization: Nakamoto coefficient 18, 679 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,146,430 |
| Block height | 425,188,406 |
| Epoch | 1035 (6.12% complete, ~35.4h left) |
| TPS (10 min avg) | 3,938 |
| Non-vote TPS | 1,825 |
| Slot time (measured) | 314.5 ms |
| Est. daily transactions | 333,524,177 |
...
| Metric | Value |
|---|---|
| SOL price | $101.42 (+0.2%/24h) |
| Market cap | $59.5B |
| **REV (24h)** | **$719.5K** (fees $608.1K + Jito tips $111.4K) |
| Chain TVL | $5.9B |
| Stablecoin supply | $16.3B |
| DEX volume (24h) | $2.2B (23.6%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,028,427 SOL |
| Inflation | 3.65% |
...
|---|---|---|
| solana_rpc | OK | 9658 ms |
| solana_rpc_validators | OK | 504 ms |
| coingecko | OK | 1817 ms |
| defillama_tvl | OK | 264 ms |
| defillama_dex | OK | 5300 ms |
| defillama_fees | OK | 4622 ms |
| defillama_stablecoins | OK | 223 ms |
| defillama_xstocks | OK | 1134 ms |
| jito_kobe | OK | 321 ms |
| stakewiz | OK | 1647 ms |
| github | OK | 996 ms |
...
| solana_rpc_whales | OK | 1398 ms |
| solana_rpc_programs | OK | 2437 ms |
