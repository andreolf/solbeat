...
> Generated 2026-09-17T13:21:15Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1036 is 59% complete (~16h remaining), with the cluster processing ~4,244 TPS (2,114 non-vote). Measured slot time is 316ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $889.6K of Real Economic Value over the last 24h ($618/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $100.48 (+3.3% / 24h). Decentralization: Nakamoto coefficient 18, 676 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 1 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 447,805,241 |
| Block height | 425,846,421 |
| Epoch | 1036 (58.62% complete, ~15.7h left) |
| TPS (10 min avg) | 4,244 |
| Non-vote TPS | 2,114 |
| Slot time (measured) | 315.8 ms |
| Est. daily transactions | 319,157,760 |
...
| Metric | Value |
|---|---|
| SOL price | $100.48 (+3.3%/24h) |
| Market cap | $59.0B |
| **REV (24h)** | **$889.6K** (fees $750.6K + Jito tips $139.0K) |
| Chain TVL | $5.8B |
| Stablecoin supply | $15.7B |
| DEX volume (24h) | $2.8B (3.6%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,212,150 SOL |
| Inflation | 3.64% |
...
- **[WARNING]** TPS spike: 4,244 vs 12h mean 3,678 (z=+2.6)
...
Crypto Fear & Greed: 50 (Neutral) · CoinGecko votes bullish: 64.52% · headline tone (48h): +0
...
| defillama_dex | OK | 4349 ms |
| defillama_fees | OK | 2441 ms |
...
| solana_rpc_programs | OK | 1906 ms |
