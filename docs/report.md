...
> Generated 2026-09-16T05:17:24Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1035 is 74% complete (~10h remaining), with the cluster processing ~3,457 TPS (1,313 non-vote). Measured slot time is 315ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $799.4K of Real Economic Value over the last 24h ($555/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $96.92 (-3.9% / 24h). Decentralization: Nakamoto coefficient 18, 678 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,440,811 |
| Block height | 425,482,318 |
| Epoch | 1035 (74.26% complete, ~9.7h left) |
| TPS (10 min avg) | 3,457 |
| Non-vote TPS | 1,313 |
| Slot time (measured) | 315.2 ms |
| Est. daily transactions | 366,319,261 |
...
| Circulating supply | 587,064,832 SOL |
| Inflation | 3.65% |
...
Crypto Fear & Greed: 51 (Neutral) · CoinGecko votes bullish: 71.88% · headline tone (48h): +1
...
| solana_rpc_whales | OK | 1435 ms |
| solana_rpc_programs | OK | 2674 ms |
