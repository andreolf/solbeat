...
> Generated 2026-09-18T00:06:37Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1036 is 87% complete (~5h remaining), with the cluster processing ~4,552 TPS (2,443 non-vote). Measured slot time is 320ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $889.4K of Real Economic Value over the last 24h ($618/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $101.60 (+3.2% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,927,234 |
| Block height | 425,968,334 |
| Epoch | 1036 (86.86% complete, ~5.0h left) |
| TPS (10 min avg) | 4,552 |
| Non-vote TPS | 2,443 |
| Slot time (measured) | 319.7 ms |
| Est. daily transactions | 380,127,889 |
...
| Circulating supply | 587,211,687 SOL |
| Inflation | 3.64% |
...
Crypto Fear & Greed: 56 (Greed) · CoinGecko votes bullish: 73.53% · headline tone (48h): +2
...
|---|---|---|
| solana_rpc | OK | 7425 ms |
| solana_rpc_validators | OK | 282 ms |
| coingecko | OK | 1626 ms |
| defillama_tvl | OK | 32 ms |
| defillama_dex | OK | 36 ms |
| defillama_fees | OK | 1431 ms |
...
| sentiment | OK | 5469 ms |
| solana_status_page | OK | 377 ms |
| solana_rpc_whales | OK | 1061 ms |
