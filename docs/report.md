...
> Generated 2026-09-12T08:30:59Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1033 is 30% complete (~27h remaining), with the cluster processing ~3,314 TPS (1,186 non-vote). Measured slot time is 317ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $971.0K of Real Economic Value over the last 24h ($674/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $101.66 (+1.8% / 24h). Decentralization: Nakamoto coefficient 18, 679 active validators, 0.4% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 446,384,487 |
| Block height | 424,427,295 |
| Epoch | 1033 (29.74% complete, ~26.8h left) |
| TPS (10 min avg) | 3,314 |
| Non-vote TPS | 1,186 |
| Slot time (measured) | 317.3 ms |
| Est. daily transactions | 301,823,545 |
...
| Metric | Value |
|---|---|
| SOL price | $101.66 (+1.8%/24h) |
| Market cap | $59.6B |
| **REV (24h)** | **$971.0K** (fees $835.7K + Jito tips $135.2K) |
| Chain TVL | $5.9B |
| Stablecoin supply | $16.5B |
| DEX volume (24h) | $3.2B (11.2%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 586,633,037 SOL |
| Inflation | 3.65% |
...
Crypto Fear & Greed: 63 (Greed) · CoinGecko votes bullish: 83.33% · headline tone (48h): +2
...
|---|---|---|
| solana_rpc | OK | 9293 ms |
| solana_rpc_validators | OK | 559 ms |
| coingecko | OK | 1698 ms |
| defillama_tvl | OK | 44 ms |
| defillama_dex | OK | 1212 ms |
| defillama_fees | OK | 5813 ms |
| defillama_stablecoins | OK | 78 ms |
| defillama_xstocks | OK | 8969 ms |
| jito_kobe | OK | 212 ms |
| stakewiz | OK | 1380 ms |
| github | OK | 804 ms |
| solana_com_news | OK | 75 ms |
| sentiment | OK | 2910 ms |
| solana_status_page | OK | 348 ms |
| solana_rpc_whales | OK | 1462 ms |
| solana_rpc_programs | OK | 2622 ms |
