...
> Generated 2026-09-22T16:43:28Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1040 is 36% complete (~21h remaining), with the cluster processing ~4,740 TPS (2,256 non-vote). Measured slot time is 271ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.3M of Real Economic Value over the last 24h ($921/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $117.15 (-0.1% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 4 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 449,436,068 |
| Block height | 427,476,417 |
| Epoch | 1040 (36.13% complete, ~20.8h left) |
| TPS (10 min avg) | 4,740 |
| Non-vote TPS | 2,256 |
| Slot time (measured) | 271.2 ms |
| Est. daily transactions | 407,901,492 |
...
| Metric | Value |
|---|---|
| SOL price | $117.15 (-0.1%/24h) |
| Market cap | $68.8B |
| **REV (24h)** | **$1.3M** (fees $1.1M + Jito tips $229.8K) |
| Chain TVL | $6.5B |
| Stablecoin supply | $17.1B |
| DEX volume (24h) | $3.4B (22.7%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,507,595 SOL |
| Inflation | 3.64% |

Top DEXs by 24h volume: Raydium AMM ($466.4M), BisonFi ($446.8M), Orca DEX ($419.0M), PumpSwap ($390.1M), Meteora DLMM ($259.6M)
...
Crypto Fear & Greed: 78 (Extreme Greed) · CoinGecko votes bullish: 72.22% · headline tone (48h): +5
...
|---|---|---|
| solana_rpc | OK | 9277 ms |
| solana_rpc_validators | OK | 306 ms |
| coingecko | OK | 1789 ms |
| defillama_tvl | OK | 134 ms |
| defillama_dex | OK | 16481 ms |
| defillama_fees | OK | 9008 ms |
| defillama_stablecoins | OK | 254 ms |
| defillama_xstocks | OK | 650 ms |
| jito_kobe | OK | 259 ms |
| stakewiz | OK | 1042 ms |
| github | OK | 852 ms |
| solana_com_news | OK | 119 ms |
| sentiment | OK | 2524 ms |
| solana_status_page | OK | 394 ms |
| solana_rpc_whales | OK | 1263 ms |
| solana_rpc_programs | OK | 2171 ms |
