...
> Generated 2026-09-12T08:00:31Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1033 is 28% complete (~27h remaining), with the cluster processing ~3,209 TPS (1,072 non-vote). Measured slot time is 316ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $971.6K of Real Economic Value over the last 24h ($675/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $101.63 (+1.9% / 24h). Decentralization: Nakamoto coefficient 18, 678 active validators, 0.4% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 446,378,728 |
| Block height | 424,421,536 |
| Epoch | 1033 (28.41% complete, ~27.1h left) |
| TPS (10 min avg) | 3,209 |
| Non-vote TPS | 1,072 |
| Slot time (measured) | 315.7 ms |
| Est. daily transactions | 304,591,625 |
...
| Metric | Value |
|---|---|
| SOL price | $101.63 (+1.9%/24h) |
| Market cap | $59.6B |
| **REV (24h)** | **$971.6K** (fees $835.7K + Jito tips $135.9K) |
| Chain TVL | $5.9B |
| Stablecoin supply | $16.5B |
| DEX volume (24h) | $3.2B (11.2%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 586,633,053 SOL |
| Inflation | 3.65% |

Top DEXs by 24h volume: Raydium AMM ($481.1M), BisonFi ($395.8M), Meteora DLMM ($363.0M), HumidiFi ($322.7M), PumpSwap ($294.2M)
...
Crypto Fear & Greed: 63 (Greed) · CoinGecko votes bullish: 83.87% · headline tone (48h): +1
...
|---|---|---|
| solana_rpc | OK | 8630 ms |
| solana_rpc_validators | OK | 542 ms |
| coingecko | OK | 1832 ms |
| defillama_tvl | OK | 49 ms |
| defillama_dex | OK | 1158 ms |
| defillama_fees | OK | 1946 ms |
| defillama_stablecoins | OK | 494 ms |
...
| solana_status_page | OK | 298 ms |
| solana_rpc_whales | OK | 1496 ms |
| solana_rpc_programs | OK | 2576 ms |
