...
> Generated 2026-09-20T13:42:42Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1038 is 77% complete (~7h remaining), with the cluster processing ~4,000 TPS (1,452 non-vote). Measured slot time is 265ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $980.9K of Real Economic Value over the last 24h ($681/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $108.00 (-3.2% / 24h). Decentralization: Nakamoto coefficient 18, 678 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 448,748,395 |
| Block height | 426,789,117 |
| Epoch | 1038 (76.94% complete, ~7.3h left) |
| TPS (10 min avg) | 4,000 |
| Non-vote TPS | 1,452 |
| Slot time (measured) | 264.9 ms |
| Est. daily transactions | 329,554,622 |
...
| Metric | Value |
|---|---|
| SOL price | $108.00 (-3.2%/24h) |
| Market cap | $63.4B |
| **REV (24h)** | **$980.9K** (fees $826.3K + Jito tips $154.6K) |
| Chain TVL | $6.1B |
| Stablecoin supply | $15.7B |
| DEX volume (24h) | $2.9B (-18.7%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,366,793 SOL |
| Inflation | 3.64% |

Top DEXs by 24h volume: PumpSwap ($606.4M), BisonFi ($386.8M), Raydium AMM ($270.0M), HumidiFi ($228.9M), Orca DEX ($206.9M)
...
Crypto Fear & Greed: 71 (Greed) · CoinGecko votes bullish: 77.78% · headline tone (48h): +5
