...
> Generated 2026-09-20T17:58:39Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1038 is 90% complete (~3h remaining), with the cluster processing ~4,834 TPS (2,314 non-vote). Measured slot time is 267ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $982.3K of Real Economic Value over the last 24h ($682/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $109.84 (-1.4% / 24h). Decentralization: Nakamoto coefficient 18, 675 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 1 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 448,805,894 |
| Block height | 426,846,597 |
| Epoch | 1038 (90.25% complete, ~3.1h left) |
| TPS (10 min avg) | 4,834 |
| Non-vote TPS | 2,314 |
| Slot time (measured) | 267.0 ms |
| Est. daily transactions | 384,589,833 |
...
| Circulating supply | 587,366,612 SOL |
| Inflation | 3.64% |
...
Crypto Fear & Greed: 71 (Greed) · CoinGecko votes bullish: 79.59% · headline tone (48h): +6
...
| solana_rpc_programs | OK | 1629 ms |
