...
> Generated 2026-09-22T03:35:10Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1039 is 95% complete (~2h remaining), with the cluster processing ~4,691 TPS (2,160 non-vote). Measured slot time is 266ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.3M of Real Economic Value over the last 24h ($876/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $116.72 (+4.4% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 4 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 449,258,711 |
| Block height | 427,299,203 |
| Epoch | 1039 (95.07% complete, ~1.6h left) |
| TPS (10 min avg) | 4,691 |
| Non-vote TPS | 2,160 |
| Slot time (measured) | 266.3 ms |
| Est. daily transactions | 396,877,881 |
...
| Metric | Value |
|---|---|
| SOL price | $116.72 (+4.4%/24h) |
| Market cap | $68.5B |
| **REV (24h)** | **$1.3M** (fees $1.1M + Jito tips $164.9K) |
| Chain TVL | $6.5B |
| Stablecoin supply | $17.1B |
| DEX volume (24h) | $3.4B (20.6%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,436,703 SOL |
| Inflation | 3.64% |
...
Crypto Fear & Greed: 78 (Extreme Greed) · CoinGecko votes bullish: 77.65% · headline tone (48h): +3
...
|---|---|---|
| solana_rpc | OK | 7062 ms |
| solana_rpc_validators | OK | 260 ms |
| coingecko | OK | 1804 ms |
| defillama_tvl | OK | 185 ms |
| defillama_dex | OK | 1258 ms |
| defillama_fees | OK | 167 ms |
| defillama_stablecoins | OK | 877 ms |
| defillama_xstocks | OK | 252 ms |
| jito_kobe | OK | 289 ms |
| stakewiz | OK | 1163 ms |
| github | OK | 941 ms |
...
| solana_rpc_programs | OK | 1722 ms |
