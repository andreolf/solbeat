...
> Generated 2026-09-13T12:39:56Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1034 is 4% complete (~36h remaining), with the cluster processing ~3,638 TPS (1,496 non-vote). Measured slot time is 314ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $842.5K of Real Economic Value over the last 24h ($585/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $99.60 (-2.6% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.4% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 446,705,109 |
| Block height | 424,747,767 |
| Epoch | 1034 (3.96% complete, ~36.2h left) |
| TPS (10 min avg) | 3,638 |
| Non-vote TPS | 1,496 |
| Slot time (measured) | 314.5 ms |
| Est. daily transactions | 297,767,893 |
...
| Metric | Value |
|---|---|
| SOL price | $99.60 (-2.6%/24h) |
| Market cap | $58.4B |
| **REV (24h)** | **$842.5K** (fees $708.8K + Jito tips $133.7K) |
| Chain TVL | $5.8B |
| Stablecoin supply | $16.5B |
| DEX volume (24h) | $1.7B (-46.9%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 586,731,206 SOL |
| Inflation | 3.65% |

Top DEXs by 24h volume: PumpSwap ($377.2M), Raydium AMM ($285.0M), BisonFi ($162.7M), Meteora DLMM ($161.1M), Orca DEX ($94.6M)
...
**49/100 — Neutral** · composite of keyless signals (not financial advice)
...
Crypto Fear & Greed: 61 (Greed) · CoinGecko votes bullish: 77.42% · headline tone (48h): -4
