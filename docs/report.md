...
> Generated 2026-09-20T13:12:17Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1038 is 75% complete (~8h remaining), with the cluster processing ~3,946 TPS (1,400 non-vote). Measured slot time is 265ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $981.2K of Real Economic Value over the last 24h ($681/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $108.33 (-2.9% / 24h). Decentralization: Nakamoto coefficient 18, 678 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 448,741,527 |
| Block height | 426,782,249 |
| Epoch | 1038 (75.35% complete, ~7.8h left) |
| TPS (10 min avg) | 3,946 |
| Non-vote TPS | 1,400 |
| Slot time (measured) | 265.1 ms |
| Est. daily transactions | 328,883,080 |
...
| Metric | Value |
|---|---|
| SOL price | $108.33 (-2.9%/24h) |
| Market cap | $63.6B |
| **REV (24h)** | **$981.2K** (fees $826.3K + Jito tips $154.9K) |
| Chain TVL | $6.1B |
| Stablecoin supply | $15.7B |
| DEX volume (24h) | $2.9B (-18.7%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,366,812 SOL |
| Inflation | 3.64% |
...
Crypto Fear & Greed: 71 (Greed) · CoinGecko votes bullish: 76.36% · headline tone (48h): +2
...
|---|---|---|
| solana_rpc | OK | 9055 ms |
| solana_rpc_validators | OK | 300 ms |
| coingecko | OK | 1673 ms |
| defillama_tvl | OK | 118 ms |
| defillama_dex | OK | 881 ms |
| defillama_fees | OK | 938 ms |
| defillama_stablecoins | OK | 262 ms |
...
| solana_rpc_programs | OK | 2165 ms |
