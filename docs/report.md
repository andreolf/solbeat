...
| Health | ok |
| Slot | 446,946,283 |
| Block height | 424,988,800 |
| Epoch | 1034 (59.79% complete, ~15.3h left) |
| TPS (10 min avg) | 3,490 |
| Non-vote TPS | 1,356 |
| Slot time (measured) | 316.1 ms |
| Est. daily transactions | 299,998,658 |
...
| Circulating supply | 586,892,852 SOL |
| Inflation | 3.65% |
...
| solana_rpc_programs | OK | 2812 ms |
