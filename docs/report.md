...
> Generated 2026-09-16T15:25:57Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1036 is 1% complete (~37h remaining), with the cluster processing ~4,458 TPS (2,316 non-vote). Measured slot time is 315ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $799.7K of Real Economic Value over the last 24h ($555/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $97.12 (-2.4% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,556,249 |
| Block height | 425,597,699 |
| Epoch | 1036 (0.98% complete, ~37.4h left) |
| TPS (10 min avg) | 4,458 |
| Non-vote TPS | 2,316 |
| Slot time (measured) | 315.0 ms |
| Est. daily transactions | 340,253,004 |
...
| Circulating supply | 587,150,703 SOL |
| Inflation | 3.64% |
...
Crypto Fear & Greed: 51 (Neutral) · CoinGecko votes bullish: 74.19% · headline tone (48h): +3
...
| solana_rpc_programs | OK | 1603 ms |
