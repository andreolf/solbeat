...
> Generated 2026-09-15T23:06:30Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1035 is 58% complete (~16h remaining), with the cluster processing ~4,699 TPS (2,567 non-vote). Measured slot time is 316ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $753.0K of Real Economic Value over the last 24h ($523/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $97.12 (-5.5% / 24h). Decentralization: Nakamoto coefficient 18, 679 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,370,715 |
| Block height | 425,412,383 |
| Epoch | 1035 (58.04% complete, ~15.9h left) |
| TPS (10 min avg) | 4,699 |
| Non-vote TPS | 2,567 |
| Slot time (measured) | 316.5 ms |
| Est. daily transactions | 415,413,176 |
...
| Metric | Value |
|---|---|
| SOL price | $97.12 (-5.5%/24h) |
| Market cap | $57.0B |
| **REV (24h)** | **$753.0K** (fees $647.0K + Jito tips $106.0K) |
| Chain TVL | $5.7B |
| Stablecoin supply | $16.3B |
| DEX volume (24h) | $2.5B (40.2%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,027,578 SOL |
| Inflation | 3.65% |

Top DEXs by 24h volume: PumpSwap ($445.4M), BisonFi ($315.8M), Raydium AMM ($255.5M), Meteora DLMM ($198.8M), Orca DEX ($193.0M)
...
| solana_rpc_programs | OK | 2111 ms |
