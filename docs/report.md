...
> Generated 2026-09-18T14:11:05Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1037 is 28% complete (~23h remaining), with the cluster processing ~5,388 TPS (2,868 non-vote). Measured slot time is 268ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.0M of Real Economic Value over the last 24h ($728/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $108.46 (+7.8% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 1 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 448,106,628 |
| Block height | 426,147,579 |
| Epoch | 1037 (28.39% complete, ~23.0h left) |
| TPS (10 min avg) | 5,388 |
| Non-vote TPS | 2,868 |
| Slot time (measured) | 267.6 ms |
| Est. daily transactions | 373,135,052 |
...
| Metric | Value |
|---|---|
| SOL price | $108.46 (+7.8%/24h) |
| Market cap | $63.7B |
| **REV (24h)** | **$1.0M** (fees $813.1K + Jito tips $235.6K) |
| Chain TVL | $6.0B |
| Stablecoin supply | $15.6B |
| DEX volume (24h) | $2.6B (-7.4%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 587,297,158 SOL |
| Inflation | 3.64% |
...
- **[WARNING]** TPS spike: 5,388 vs 12h mean 4,282 (z=+2.5)
...
|---|---|---|
| solana_rpc | OK | 12035 ms |
| solana_rpc_validators | OK | 1219 ms |
| coingecko | OK | 1715 ms |
| defillama_tvl | OK | 158 ms |
| defillama_dex | OK | 505 ms |
| defillama_fees | OK | 1566 ms |
| defillama_stablecoins | OK | 938 ms |
| defillama_xstocks | OK | 70 ms |
| jito_kobe | OK | 444 ms |
| stakewiz | OK | 1238 ms |
| github | OK | 950 ms |
| solana_com_news | OK | 253 ms |
| sentiment | OK | 2451 ms |
| solana_status_page | OK | 402 ms |
| solana_rpc_whales | OK | 2901 ms |
| solana_rpc_programs | OK | 5065 ms |
