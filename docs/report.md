...
> Generated 2026-09-22T22:30:00Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1040 is 54% complete (~15h remaining), with the cluster processing ~4,347 TPS (1,836 non-vote). Measured slot time is 268ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.3M of Real Economic Value over the last 24h ($924/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $118.10 (-0.9% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 4 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 449,513,670 |
| Block height | 427,553,993 |
| Epoch | 1040 (54.09% complete, ~14.8h left) |
| TPS (10 min avg) | 4,347 |
| Non-vote TPS | 1,836 |
| Slot time (measured) | 268.3 ms |
| Est. daily transactions | 405,836,351 |
...
| Circulating supply | 587,507,334 SOL |
| Inflation | 3.64% |

Top DEXs by 24h volume: Raydium AMM ($493.5M), BisonFi ($446.8M), PumpSwap ($390.1M), Orca DEX ($377.1M), Meteora DLMM ($259.6M)
...
Crypto Fear & Greed: 78 (Extreme Greed) · CoinGecko votes bullish: 72.88% · headline tone (48h): +6
...
| solana_rpc_programs | OK | 1365 ms |
