...
> Generated 2026-09-16T07:25:03Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1035 is 80% complete (~8h remaining), with the cluster processing ~3,444 TPS (1,305 non-vote). Measured slot time is 316ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $799.4K of Real Economic Value over the last 24h ($555/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $97.00 (-3.9% / 24h). Decentralization: Nakamoto coefficient 18, 678 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,465,040 |
| Block height | 425,506,539 |
| Epoch | 1035 (79.87% complete, ~7.6h left) |
| TPS (10 min avg) | 3,444 |
| Non-vote TPS | 1,305 |
| Slot time (measured) | 315.5 ms |
| Est. daily transactions | 327,148,511 |
...
| Circulating supply | 587,064,761 SOL |
| Inflation | 3.65% |
...
|---|---|---|
| solana_rpc | OK | 9766 ms |
| solana_rpc_validators | OK | 463 ms |
...
| solana_rpc_programs | OK | 2715 ms |
