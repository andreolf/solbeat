...
> Generated 2026-09-04T06:17:38Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1028 is 18% complete (~31h remaining), with the cluster processing ~3,229 TPS (1,096 non-vote). Measured slot time is 315ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $700.2K of Real Economic Value over the last 24h ($486/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $103.85 (+3.2% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: 4 signal(s) flagged — see Signals below.
...
| Health | ok |
| Slot | 444,174,612 |
| Block height | 422,220,811 |
| Epoch | 1028 (18.2% complete, ~30.9h left) |
| TPS (10 min avg) | 3,229 |
| Non-vote TPS | 1,096 |
| Slot time (measured) | 314.9 ms |
| Est. daily transactions | 292,677,317 |
...
| Metric | Value |
|---|---|
| SOL price | $103.85 (+3.2%/24h) |
| Market cap | $60.8B |
| **REV (24h)** | **$700.2K** (fees $594.5K + Jito tips $105.7K) |
| Chain TVL | $5.9B |
| Stablecoin supply | $16.6B |
| DEX volume (24h) | $2.4B (3.7%/1d) |
| Tokenized equities (xStocks TVL) | $458.6M |
| Circulating supply | 585,360,538 SOL |
| Inflation | 3.66% |

Top DEXs by 24h volume: PumpSwap ($838.7M), Orca DEX ($282.4M), BisonFi ($232.5M), Meteora DLMM ($186.5M), Manifest Trade ($174.7M)
...
Crypto Fear & Greed: 74 (Greed) · CoinGecko votes bullish: 76.09% · headline tone (48h): +0
...
|---|---|---|
| solana_rpc | OK | 9988 ms |
| solana_rpc_validators | OK | 629 ms |
| coingecko | OK | 1687 ms |
| defillama_tvl | OK | 60 ms |
| defillama_dex | OK | 752 ms |
| defillama_fees | OK | 54 ms |
...
| solana_rpc_whales | OK | 1628 ms |
| solana_rpc_programs | OK | 2917 ms |
