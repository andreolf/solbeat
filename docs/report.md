...
> Generated 2026-09-15T09:16:51Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1035 is 22% complete (~30h remaining), with the cluster processing ~3,363 TPS (1,228 non-vote). Measured slot time is 316ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $757.0K of Real Economic Value over the last 24h ($526/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $100.56 (-0.8% / 24h). Decentralization: Nakamoto coefficient 18, 680 active validators, 0.0% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 447,213,543 |
| Block height | 425,255,463 |
| Epoch | 1035 (21.65% complete, ~29.7h left) |
| TPS (10 min avg) | 3,363 |
| Non-vote TPS | 1,228 |
| Slot time (measured) | 315.7 ms |
| Est. daily transactions | 305,714,957 |
...
| Circulating supply | 587,028,138 SOL |
| Inflation | 3.65% |
...
|---|---|---|
| solana_rpc | OK | 8935 ms |
| solana_rpc_validators | OK | 322 ms |
| coingecko | OK | 1764 ms |
| defillama_tvl | OK | 279 ms |
| defillama_dex | OK | 931 ms |
| defillama_fees | OK | 1519 ms |
| defillama_stablecoins | OK | 851 ms |
...
| solana_rpc_programs | OK | 2453 ms |
