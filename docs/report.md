...
> Generated 2026-09-10T05:02:05Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1031 is 94% complete (~2h remaining), with the cluster processing ~3,776 TPS (1,676 non-vote). Measured slot time is 318ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.1M of Real Economic Value over the last 24h ($756/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $101.95 (-2.3% / 24h). Decentralization: Nakamoto coefficient 18, 675 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 445,799,112 |
| Block height | 423,842,503 |
| Epoch | 1031 (94.24% complete, ~2.2h left) |
| TPS (10 min avg) | 3,776 |
| Non-vote TPS | 1,676 |
| Slot time (measured) | 317.9 ms |
| Est. daily transactions | 349,306,272 |
...
| Metric | Value |
|---|---|
| SOL price | $101.95 (-2.3%/24h) |
| Market cap | $59.8B |
| **REV (24h)** | **$1.1M** (fees $978.5K + Jito tips $110.9K) |
| Chain TVL | $5.8B |
| Stablecoin supply | $16.5B |
| DEX volume (24h) | $2.6B (-5.7%/1d) |
| Tokenized equities (xStocks TVL) | $437.9M |
| Circulating supply | 586,249,849 SOL |
| Inflation | 3.66% |

Top DEXs by 24h volume: Raydium AMM ($410.6M), PumpSwap ($341.0M), Meteora DLMM ($322.2M), BisonFi ($249.3M), Orca DEX ($169.5M)
...
Crypto Fear & Greed: 69 (Greed) · CoinGecko votes bullish: 72.97% · headline tone (48h): +2
...
|---|---|---|
| solana_rpc | OK | 12732 ms |
| solana_rpc_validators | OK | 1335 ms |
| coingecko | OK | 1652 ms |
| defillama_tvl | OK | 146 ms |
| defillama_dex | OK | 1865 ms |
| defillama_fees | OK | 299 ms |
| defillama_stablecoins | OK | 155 ms |
| defillama_xstocks | OK | 98 ms |
| jito_kobe | OK | 289 ms |
| stakewiz | OK | 923 ms |
| github | OK | 600 ms |
...
| solana_rpc_whales | OK | 3023 ms |
| solana_rpc_programs | OK | 5054 ms |
