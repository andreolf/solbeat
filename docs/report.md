...
> Generated 2026-09-10T15:12:09Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1032 is 21% complete (~30h remaining), with the cluster processing ~4,167 TPS (2,048 non-vote). Measured slot time is 317ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $1.1M of Real Economic Value over the last 24h ($794/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $100.02 (-2.7% / 24h). Decentralization: Nakamoto coefficient 18, 675 active validators, 0.1% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 445,915,060 |
| Block height | 423,958,415 |
| Epoch | 1032 (21.08% complete, ~30.0h left) |
| TPS (10 min avg) | 4,167 |
| Non-vote TPS | 2,048 |
| Slot time (measured) | 317.2 ms |
| Est. daily transactions | 356,368,132 |
...
| Metric | Value |
|---|---|
| SOL price | $100.02 (-2.7%/24h) |
| Market cap | $58.6B |
| **REV (24h)** | **$1.1M** (fees $978.5K + Jito tips $165.0K) |
| Chain TVL | $5.8B |
| Stablecoin supply | $16.5B |
| DEX volume (24h) | $3.0B (10.7%/1d) |
| Tokenized equities (xStocks TVL) | $430.2M |
| Circulating supply | 586,335,537 SOL |
| Inflation | 3.65% |

Top DEXs by 24h volume: BisonFi ($402.8M), Raydium AMM ($348.4M), PumpSwap ($341.0M), Meteora DLMM ($322.2M), HumidiFi ($285.6M)
...
|---|---|---|
| solana_rpc | OK | 10859 ms |
| solana_rpc_validators | OK | 771 ms |
| coingecko | OK | 2383 ms |
| defillama_tvl | OK | 86 ms |
| defillama_dex | OK | 3300 ms |
| defillama_fees | OK | 3176 ms |
| defillama_stablecoins | OK | 6025 ms |
...
| solana_rpc_whales | OK | 1919 ms |
| solana_rpc_programs | OK | 3251 ms |
