...
> Generated 2026-09-13T12:09:25Z · zero API keys · Python stdlib + public endpoints

## Analyst commentary

Epoch 1034 is 3% complete (~37h remaining), with the cluster processing ~3,310 TPS (1,173 non-vote). Measured slot time is 316ms — live on-chain evidence that SIMD-0525's first slot-time reduction step (350ms target) is active on mainnet. The network earned $842.2K of Real Economic Value over the last 24h ($585/minute), computed as base + priority fees plus Jito MEV tips. SOL trades at $99.72 (-2.4% / 24h). Decentralization: Nakamoto coefficient 18, 677 active validators, 0.4% of stake delinquent. Alpenglow readiness: validators holding 99% of stake have registered BLS keys ahead of the consensus upgrade. Anomaly scan: all clear across every monitored metric.
...
| Health | ok |
| Slot | 446,699,303 |
| Block height | 424,741,961 |
| Epoch | 1034 (2.62% complete, ~36.9h left) |
| TPS (10 min avg) | 3,310 |
| Non-vote TPS | 1,173 |
| Slot time (measured) | 315.7 ms |
| Est. daily transactions | 296,572,738 |
...
| Metric | Value |
|---|---|
| SOL price | $99.72 (-2.4%/24h) |
| Market cap | $58.5B |
| **REV (24h)** | **$842.2K** (fees $708.8K + Jito tips $133.3K) |
| Chain TVL | $5.8B |
| Stablecoin supply | $16.5B |
| DEX volume (24h) | $1.7B (-46.9%/1d) |
| Tokenized equities (xStocks TVL) | n/a |
| Circulating supply | 586,731,278 SOL |
| Inflation | 3.65% |
...
**48/100 — Neutral** · composite of keyless signals (not financial advice)
...
Crypto Fear & Greed: 61 (Greed) · CoinGecko votes bullish: 69.7% · headline tone (48h): -3
...
|---|---|---|
| solana_rpc | OK | 12800 ms |
| solana_rpc_validators | OK | 1321 ms |
| coingecko | OK | 1689 ms |
| defillama_tvl | OK | 76 ms |
| defillama_dex | OK | 413 ms |
| defillama_fees | OK | 92 ms |
...
| solana_rpc_whales | OK | 3137 ms |
| solana_rpc_programs | OK | 5381 ms |
